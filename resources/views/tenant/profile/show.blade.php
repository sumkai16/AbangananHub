            ...
            <x-card flush class="p-5">
                ...
                @empty
                    <div class="py-9 text-center">
                        ...
                        <a href="{{ route('properties.index') }}" class="inline-flex items-center gap-1.5 px-4 py-2 rounded-full text-[12.5px] font-semibold text-[#060D26] bg-[#DA8E77] hover:bg-[#C97A61] transition-all">
                            Browse properties
                        </a>
                    </div>
                @endforelse
