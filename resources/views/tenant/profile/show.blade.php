            ...
            <x-card flush class="p-5">
                ...
                @empty
                    <div class="py-9 text-center">
                        ...
                        <a href="{{ route('properties.index') }}" class="inline-flex items-center gap-1.5 px-4 py-2 rounded-full text-[12.5px] font-semibold text-white bg-[#060D26] hover:brightness-95 transition-all">
                            Browse properties
                        </a>
                    </div>
                @endforelse
