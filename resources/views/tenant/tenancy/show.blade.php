            ...
            <div class="flex flex-col lg:flex-row lg:items-center gap-5">
                ...
                @if($reservation->conversation)
                    <a href="{{ route('conversations.show', $reservation->conversation) }}"
                        class="h-11 px-4 inline-flex items-center gap-2 rounded-full border border-[#E2E8F0] bg-white text-[#1F2937] text-sm font-semibold hover:bg-[#F7FCFC] transition-all duration-200 cursor-pointer shrink-0">
