                ...
                <div class="flex items-center gap-2 shrink-0">
                    @if($canReview)
                        <a href="{{ route('properties.show', $reservation->property) }}#reviews"
                            class="h-11 px-4 inline-flex items-center gap-2 rounded-full bg-[#DA8E77] text-[#060D26] text-sm font-semibold hover:bg-[#C97A61] transition-all duration-200 cursor-pointer">
                    ...
                    <x-card class="!bg-[#ECEEF6] !border-[#DA8E77]/25">
                        <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                            ...
                            <form method="POST" action="{{ route('payments.rentCheckout', $reservation) }}" class="shrink-0">
                                @csrf
                                <button type="submit"
                                    class="h-11 px-6 w-full sm:w-auto inline-flex items-center justify-center gap-2 rounded-full bg-[#DA8E77] text-[#060D26] text-sm font-semibold hover:bg-[#C97A61] transition-all duration-200 cursor-pointer">
