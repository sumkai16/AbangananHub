    ...
    <div class="relative p-8">
        ...
        <div class="mb-6">
            <div class="flex items-center gap-2 mb-4">
                ...
                <span class="text-[#1A1A2E] font-bold text-lg tracking-tight">Abanganan<span class="text-[#2AA7A1]">Hub</span></span>
            </div>
        ...
        <form method="POST" action="{{ route('login') }}" class="space-y-4">
            ...
            <div>
                ...
                <input id="login_email" type="email" name="email" value="{{ old('email') }}" required autocomplete="username" placeholder="Enter your email"
                    class="w-full px-3 py-2.5 bg-slate-50/50 border border-slate-300 rounded-lg text-sm text-[#1A1A2E] placeholder-[#64748B] transition-all focus:bg-white focus:outline-none focus:border-[#2AA7A1] focus:ring-4 focus:ring-[#2AA7A1]/10" />
            </div>
