...
>
    ...
    <div class="flex items-center justify-between mb-3">
        <div class="flex items-center gap-2.5">
            ...
            <div>
                <p class="text-[13px] font-semibold text-[#060D26]">Unit Photos</p>
    ...
    <div x-show="cameraReady && shots.length < max" x-cloak class="relative rounded-xl overflow-hidden bg-black mb-3 aspect-video ring-1 ring-black/10">
        ...
        >
            <span class="w-11 h-11 rounded-full bg-[#060D26]"></span>
        </button>
    </div>
    ...
    <div class="grid grid-cols-4 sm:grid-cols-5 gap-2 mt-1" x-show="shots.length > 0">
        <template x-for="(shot, index) in shots" :key="shot.id">
            <div class="relative aspect-square rounded-lg overflow-hidden bg-[#ECEEF6] ring-1 ring-[#5B6A8E]/15 group">
    ...
    <p x-show="shots.length >= max" x-cloak class="text-[11px] text-[#5B6A8E] mt-3 text-center">
