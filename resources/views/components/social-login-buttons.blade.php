...
<div class="grid grid-cols-2 gap-3">
    <a href="{{ route('social.redirect', 'google') }}"
        class="flex items-center justify-center gap-2 border border-[#E2E4EC] rounded-xl py-2.5 text-[13px] font-bold text-[#334155] hover:brightness-95 cursor-pointer transition-all duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-[#C9A84C]/20">
