...
<div class="relative my-5">
    ...
    <div class="relative flex justify-center text-[11px]">
        <span class="bg-white px-3 text-[#94A3B8] font-['Plus_Jakarta_Sans',_Inter,_sans-serif] font-bold uppercase tracking-[0.14em]">or continue with</span>
    </div>
</div>
<div class="grid grid-cols-2 gap-3">
    <a href="{{ route('social.redirect', 'google') }}"
<<<<<<< HEAD
        class="flex items-center justify-center gap-2 border border-[#E2E4EC] rounded-xl py-2.5 text-[13px] font-bold text-[#334155] hover:brightness-95 cursor-pointer transition-all duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-[#DA8E77]/20">
=======
        class="flex items-center justify-center gap-2 border border-[#E2E4EC] rounded-full py-2.5 font-['Plus_Jakarta_Sans',_Inter,_sans-serif] text-[13px] font-bold text-[#334155] hover:border-[#FF8A66] hover:bg-[#FF8A66]/5 cursor-pointer transition-all duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-[#FF8A66]/20">
