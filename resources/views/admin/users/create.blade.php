...
<div class="max-w-2xl mx-auto">
    ...
    <x-card flush>
        <div class="px-7 py-5 border-b border-[#E2E4EC]">
            <h1 class="text-[18px] font-normal text-[#060D26] tracking-tight">Create User</h1>
...
=======
                        class="w-full h-10 px-3.5 text-[13.5px] rounded-xl border {{ $errors->has('password') ? 'border-[#EF4444]/35 bg-[#EF4444]/[0.07]' : 'border-[#E2E4EC] bg-[#F7F8FC]' }} focus:outline-none focus:ring-2 focus:ring-[#FF8A66]/20 focus:border-[#FF8A66] transition-all">
>>>>>>> 092fb1454a20ae889717d4d8b1bee67f9c0c8eaa
