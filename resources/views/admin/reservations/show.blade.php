                ...
                <div class="p-5">
                    ...
                    @if($tenant)
                        <a href="{{ route('admin.users.show', $tenant) }}"
                            class="mt-4 flex items-center justify-center gap-1.5 w-full h-8 rounded-xl bg-[#F7F8FC] border border-[#E2E4EC] text-[12px] font-semibold text-[#5B6A8E] hover:bg-[#DA8E77] hover:text-[#060D26] hover:border-[#DA8E77] transition-all">
                            View Profile
                        </a>
                    @endif
                </div>
                ...
                <div class="p-5">
                    ...
                    @if($landlord)
                        <a href="{{ route('admin.users.show', $landlord) }}"
                            class="flex items-center justify-center gap-1.5 w-full h-8 rounded-xl bg-[#F7F8FC] border border-[#E2E4EC] text-[12px] font-semibold text-[#5B6A8E] hover:bg-[#DA8E77] hover:text-[#060D26] hover:border-[#DA8E77] transition-all">
                            View Profile
                        </a>
                    @endif
                </div>
