...
<div class="max-w-5xl">
    ...
    {{-- Flash --}}
    @if(session('status'))
        <div class="mb-6 px-4 py-3 rounded-2xl bg-emerald-50 border border-emerald-100 text-emerald-700 text-[13.5px] font-medium">
            {{ session('status') }}
        </div>
    @endif
                ...
                <table class="min-w-full">
                    <thead>
                        <tr class="bg-gray-50/60 border-b border-gray-100">
                            <th class="px-6 py-3 text-left text-[11px] font-bold uppercase tracking-wider text-gray-400">Reporter</th>
                            <th class="px-6 py-3 text-left text-[11px] font-bold uppercase tracking-wider text-gray-400">Target</th>
                            <th class="px-6 py-3 text-left text-[11px] font-bold uppercase tracking-wider text-gray-400">Reason</th>
                    ...
                    <tbody class="divide-y divide-gray-50">
                        @foreach ($reports as $report)
                            <tr class="hover:bg-gray-50/50 transition-colors">
                                ...
                                <td class="px-6 py-4">
                                    @if($report->property)
                                        <span class="inline-flex items-center px-2 py-0.5 rounded-full bg-gray-50 border border-gray-100 text-[11.5px] font-medium text-[#1A1A2E]">
