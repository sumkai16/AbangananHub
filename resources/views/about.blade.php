...
<style>
    ...
    .feature-card:hover { box-shadow: 0 12px 40px rgba(201,168,76,0.10); }
    .step-line::after {
        content: '';
        position: absolute;
        top: 50%;
        ...
        width: 100%;
        height: 2px;
        background: linear-gradient(90deg, #C9A84C 0%, #E2E4EC 100%);
    ...
    <div class="relative max-w-5xl mx-auto px-6 py-24 text-center">
        ...
        <div class="flex flex-wrap justify-center gap-3 mt-8 fade-up" style="transition-delay:.24s">
            <a href="{{ route('properties.index') }}"
               class="h-11 px-7 bg-[#060D26] hover:brightness-95 text-white font-bold text-[14px] rounded-full transition-all shadow-lg shadow-[#C9A84C]/30 flex items-center gap-2">
                Browse Properties
...
<section class="bg-white border-b border-[#E2E4EC]">
    <div class="max-w-5xl mx-auto px-6 py-10 grid grid-cols-2 md:grid-cols-4 gap-6">
        ...
        <div class="stat-card text-center transition-transform duration-300 fade-up">
            <div class="w-11 h-11 rounded-2xl bg-[#C9A84C]/10 flex items-center justify-center mx-auto mb-3">
    ...
    <div class="max-w-5xl mx-auto px-6">
        ...
        <div class="grid md:grid-cols-2 gap-6">
            ...
            <div class="feature-card bg-white rounded-3xl p-8 border border-[#E2E4EC] shadow-sm transition-all duration-300 fade-up">
                <div class="w-12 h-12 rounded-2xl bg-[#060D26] flex items-center justify-center mb-5 shadow-md shadow-[#C9A84C]/30">
    ...
    <div class="max-w-5xl mx-auto px-6">
        ...
        <div class="mb-14 fade-up">
            <div class="flex items-center gap-2 mb-8">
                <div class="w-7 h-7 rounded-lg bg-[#C9A84C]/10 flex items-center justify-center">
                    <svg width="14" height="14" fill="none" viewBox="0 0 24 24" stroke="#C9A84C" stroke-width="2.5">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"/>
                    </svg>
                </div>
                <span class="text-[13px] font-bold text-[#060D26] uppercase tracking-wider">For Tenants</span>
            </div>
            <div class="relative pl-8 border-l-2 border-[#C9A84C]/20 space-y-6">
                @foreach([
...
<section class="bg-[#F7F8FC] py-20">
    <div class="max-w-5xl mx-auto px-6">
        ...
        <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
            @foreach([
                ['icon'=>'M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z', 'title'=>'Verified Landlords', 'desc'=>'Every landlord is vetted through a document verification process before their listings go live.', 'color'=>'#C9A84C'],
                ['icon'=>'M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z', 'title'=>'Smart Search & Filter', 'desc'=>'Find rentals by location, property type (Bedspace, Room, Apartment, House), and maximum budget.', 'color'=>'#C9A84C'],
                ...
                ['icon'=>'M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z', 'title'=>'Saved Listings', 'desc'=>'Bookmark your favourite properties and revisit them any time from your Saved Listings tab.', 'color'=>'#C9A84C'],
            ...
            <div class="relative grid md:grid-cols-2 gap-10 items-center">
                <div>
                    ...
                    <h2 class="text-[26px] sm:text-[32px] font-normal leading-tight mb-4">
                        Aligned with <span class="text-[#C9A84C]">SDG 16</span>
                    </h2>
...
<section class="bg-[#F7F8FC] py-20">
    <div class="max-w-2xl mx-auto px-6 text-center fade-up">
        ...
        <div class="flex flex-wrap justify-center gap-3">
            <a href="{{ route('properties.index') }}"
               class="h-12 px-8 bg-[#060D26] hover:brightness-95 text-white font-bold text-[14.5px] rounded-full transition-all shadow-lg shadow-[#C9A84C]/25 flex items-center gap-2">
                Browse Listings
                <svg width="14" height="14" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2.5">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M9 5l7 7-7 7"/>
                </svg>
