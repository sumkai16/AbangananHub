            ...
            <div class="grid lg:grid-cols-[1fr_280px] gap-6 items-start">
                ...
                <form method="POST" action="{{ route('reports.store') }}"
                    ...
                    <div class="flex items-center gap-3 pt-2">
                        <button type="submit"
                            class="h-11 px-6 inline-flex items-center justify-center rounded-full bg-[#DA8E77] text-[#060D26] text-sm font-semibold hover:bg-[#C97A61] transition-all duration-200">
                            Submit report
                        </button>
