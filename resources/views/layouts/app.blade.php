...
<body class="font-sans bg-[#F7F8FA] text-[#1A1A2E] min-h-screen flex flex-col" x-data="{}">
        ...
        <div class="flex items-center justify-between px-4 sm:px-6 lg:px-10 h-[72px]">
            ...
            <div class="flex items-center gap-3">
                ...
                <a href="{{ route('notifications.index') }}"
                    ...
                    @if($unread > 0)
                        <div class="absolute top-[7px] right-[7px] w-2.5 h-2.5 rounded-full bg-[#286CD2] border-2 border-white"></div>
                    @endif
                ...
                @else
                    ...
                    <div class="flex items-center gap-1 sm:gap-2">
                        <button type="button" onclick="openAuthModal('login')" class="text-[13px] sm:text-[14px] font-bold text-[#1A1A2E] hover:bg-gray-100 px-3 sm:px-4 py-2 rounded-full transition-colors focus:outline-none whitespace-nowrap">Log in</button>
                        <button type="button" onclick="openAuthModal('register')" class="text-[13px] sm:text-[14px] font-bold text-white bg-[#286CD2] hover:bg-[#1D4ED8] px-4 sm:px-5 py-2 rounded-full transition-all shadow-sm focus:outline-none whitespace-nowrap">Sign up</button>
                    </div>
                @endauth
            </div>
        </div>
        ...
        @if(($searchBar ?? true) && !View::hasSection('hide_search'))
            ...
            <div class="flex justify-center pb-4 pt-1 px-4 sm:px-6">
                <form action="{{ route('properties.index') }}" method="GET"
                    ...
                    <div class="flex-1 flex flex-col justify-center px-3 py-2 sm:px-7 sm:py-3 border-r border-gray-200 cursor-pointer hover:bg-gray-50 rounded-l-full transition-colors w-[33%] overflow-hidden">
                    ...
                    <div class="flex-1 flex flex-col justify-center px-3 py-2 sm:px-7 sm:py-3 border-r border-gray-200 hover:bg-gray-50 transition-colors w-[33%] overflow-hidden">
                    ...
                    <div class="flex-1 flex items-center justify-between pl-3 pr-2 sm:pl-7 sm:pr-2 py-2 hover:bg-gray-50 rounded-r-full transition-colors w-[33%] overflow-hidden">
                        ...
                        <button type="submit"
                            ...
                            <svg width="14" height="14" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="3" class="sm:w-[17px] sm:h-[17px]">
            ...
            <div class="flex items-center justify-start md:justify-center gap-4 sm:gap-6 md:gap-8 px-4 sm:px-6 overflow-x-auto pb-1" style="-ms-overflow-style:none; scrollbar-width:none;">
    ...
    {{-- ========================================== --}}
    @guest
    <div id="auth-modal" class="hidden fixed inset-0 z-[9999] bg-[#1A1A2E]/40 backdrop-blur-sm items-center justify-center p-4">
        
        <div class="bg-white rounded-[24px] shadow-2xl max-w-md w-full p-6 md:p-8 relative transition-all transform scale-100 opacity-100 duration-300 max-h-[calc(100vh-2rem)] overflow-y-auto [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]" id="auth-modal-content">
            
            <button type="button" onclick="closeAuthModal()" class="absolute top-5 right-5 text-gray-400 hover:text-gray-600 focus:outline-none transition-colors">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M6 18L18 6M6 6l12 12"></path>
                </svg>
            </button>

            <div id="modal-error-bag" class="hidden mb-4 p-3 bg-red-50 text-red-600 rounded-xl text-sm border border-red-100"></div>
            ...
            <div id="login-form-view" class="hidden">
                <div class="flex items-center gap-3 mb-6">
                    ...
                    <span class="text-xl font-bold text-[#1A1A2E]">Abanganan<span class="text-[#286CD2]">Hub</span></span>
                </div>
                ...
                <form id="ajax-login-form" onsubmit="handleAuthSubmit(event, '{{ route('login') }}')">
                    ...
                    <div class="flex items-center justify-between text-[13px] mb-6">
                        <label class="flex items-center gap-2 text-gray-500 cursor-pointer select-none">
                            <input type="checkbox" name="remember" class="w-4 h-4 rounded text-[#286CD2] border-gray-300 focus:ring-[#286CD2]">
                            Remember me
                        </label>
                        <a href="#" class="text-[#286CD2] font-semibold hover:underline">Forgot Password?</a>
                    </div>

                    <button type="submit" class="w-full bg-[#286CD2] text-white font-bold py-3 rounded-xl hover:bg-[#1D4ED8] active:scale-[0.99] transition-all shadow-md shadow-[#286CD2]/10 text-[15px]">
                        Login
                    </button>
                </form>

                <p class="text-[13px] text-center text-gray-500 mt-6">
                    Don't have an account? <a href="#" onclick="openAuthModal('register')" class="text-[#286CD2] font-bold hover:underline">Register here</a>
                </p>
            ...
            <div id="register-form-view" class="hidden">
                ...
                <p class="text-[13px] text-center text-gray-500 mt-6">
                    Already have an account? <a href="#" onclick="openAuthModal('login')" class="text-[#286CD2] font-bold hover:underline">Login here</a>
                </p>
