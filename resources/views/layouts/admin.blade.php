        ...
        <aside id="admin-sidebar"
            ...
            <nav class="flex-1 overflow-y-auto overflow-x-hidden px-3 py-4 space-y-0.5 scrollbar-thin">
                ...
                <a href="{{ route('admin.users.index', ['role' => 'Landlord']) }}"
                    class="group relative flex items-center gap-3 px-3 py-2 rounded-xl text-[13px] font-medium transition-all duration-150 text-white/60 hover:bg-white/[0.06] hover:text-white/90">
                    <svg width="16" height="16" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.8" class="shrink-0">
                ...
                @foreach ([
                    ['Reviews & Ratings', 'M11.48 3.499a.562.562 0 011.04 0l2.125 5.111a.563.563 0 00.475.345l5.518.442c.499.04.701.663.321.988l-4.204 3.602a.563.563 0 00-.182.557l1.285 5.385a.562.562 0 01-.84.61l-4.725-2.885a.563.563 0 00-.586 0L6.982 20.54a.562.562 0 01-.84-.61l1.285-5.386a.562.562 0 00-.182-.557l-4.204-3.602a.562.562 0 01.321-.988l5.518-.442a.563.563 0 00.475-.345L11.48 3.5z'],
                    ['Complaints / Reports', 'M12 9v3.75m-9.303 3.376c-.866 1.5.217 3.374 1.948 3.374h14.71c1.73 0 2.813-1.874 1.948-3.374L13.949 3.378c-.866-1.5-3.032-1.5-3.898 0L2.697 16.126zM12 15.75h.008v.008H12v-.008z'],
                ] as [$label, $icon])
                    <div class="group relative flex items-center gap-3 px-3 py-2 rounded-xl text-[13px] font-medium text-white/30 cursor-not-allowed select-none">
                        <svg width="16" height="16" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.8" class="shrink-0">
                            <path stroke-linecap="round" stroke-linejoin="round" d="{{ $icon }}" />
            ...
            <header class="h-[64px] bg-white border-b border-gray-100 flex items-center justify-between px-5 sm:px-7 shrink-0 sticky top-0 z-30">
                ...
                <div class="hidden lg:block">
                    @hasSection('page-title')
                        <h2 class="text-[15px] font-bold text-[#1A1A2E]">@yield('page-title')</h2>
                    @endif
                </div>
