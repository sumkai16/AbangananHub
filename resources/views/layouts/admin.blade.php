            ...
            <nav class="flex-1 overflow-y-auto overflow-x-hidden px-3 py-4 space-y-0.5 scrollbar-thin">
                ...
                <a href="{{ route('admin.dashboard') }}"
                    class="group relative flex items-center gap-3 px-3 py-2 rounded-xl text-[13px] font-medium transition-all duration-200 mb-3
                        {{ $cur === 'admin.dashboard' ? 'bg-[#060D26] text-white border-l-[3px] border-[#FF8A66]' : 'text-white/60 border-l-[3px] border-transparent hover:bg-white/[0.06] hover:text-[#FF8A66]' }}">
                    <svg width="16" height="16" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.8" class="shrink-0">
                ...
                <a href="{{ route('admin.users.index') }}"
                    class="group relative flex items-center gap-3 px-3 py-2 rounded-xl text-[13px] font-medium transition-all duration-200
                        {{ ($cur === 'admin.users.index' && !$usersRoleFilter) || $cur === 'admin.users.show' ? 'bg-[#060D26] text-white border-l-[3px] border-[#FF8A66]' : 'text-white/60 border-l-[3px] border-transparent hover:bg-white/[0.06] hover:text-[#FF8A66]' }}">
                    <svg width="16" height="16" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.8" class="shrink-0">
                ...
                <a href="{{ route('admin.users.index', ['role' => 'Landlord']) }}"
                    class="group relative flex items-center gap-3 px-3 py-2 rounded-xl text-[13px] font-medium transition-all duration-200
                        {{ $cur === 'admin.users.index' && $usersRoleFilter === 'Landlord' ? 'bg-[#060D26] text-white border-l-[3px] border-[#FF8A66]' : 'text-white/60 border-l-[3px] border-transparent hover:bg-white/[0.06] hover:text-[#FF8A66]' }}">
                    <svg width="16" height="16" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.8" class="shrink-0">
                ...
                <a href="{{ route('admin.users.index', ['role' => 'Tenant']) }}"
                    class="group relative flex items-center gap-3 px-3 py-2 rounded-xl text-[13px] font-medium transition-all duration-200
                        {{ $cur === 'admin.users.index' && $usersRoleFilter === 'Tenant' ? 'bg-[#060D26] text-white border-l-[3px] border-[#FF8A66]' : 'text-white/60 border-l-[3px] border-transparent hover:bg-white/[0.06] hover:text-[#FF8A66]' }}">
                    <svg width="16" height="16" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.8" class="shrink-0">
                ...
                <a href="{{ route('admin.verifications.index') }}"
                    class="group relative flex items-center gap-3 px-3 py-2 rounded-xl text-[13px] font-medium transition-all duration-200
                        {{ str_starts_with($cur ?? '', 'admin.verifications') ? 'bg-[#060D26] text-white border-l-[3px] border-[#FF8A66]' : 'text-white/60 border-l-[3px] border-transparent hover:bg-white/[0.06] hover:text-[#FF8A66]' }}">
                    <svg width="16" height="16" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.8" class="shrink-0">
                ...
                <a href="{{ route('admin.listings.approval') }}"
                    class="group relative flex items-center gap-3 px-3 py-2 rounded-xl text-[13px] font-medium transition-all duration-200
                        {{ $cur === 'admin.listings.approval' ? 'bg-[#060D26] text-white border-l-[3px] border-[#FF8A66]' : 'text-white/60 border-l-[3px] border-transparent hover:bg-white/[0.06] hover:text-[#FF8A66]' }}">
                    <svg width="16" height="16" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.8" class="shrink-0">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M2.25 12l8.954-8.955c.44-.439 1.152-.439 1.591 0L21.75 12M4.5 9.75v10.125c0 .621.504 1.125 1.125 1.125H9.75v-4.875c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125V21h4.125c.621 0 1.125-.504 1.125-1.125V9.75M8.25 21h8.25" />
                    </svg>
                ...
                <a href="{{ route('admin.documents.index') }}"
                    class="group relative flex items-center gap-3 px-3 py-2 rounded-xl text-[13px] font-medium transition-all duration-200
                        {{ str_starts_with($cur ?? '', 'admin.documents') ? 'bg-[#060D26] text-white border-l-[3px] border-[#FF8A66]' : 'text-white/60 border-l-[3px] border-transparent hover:bg-white/[0.06] hover:text-[#FF8A66]' }}">
                    <svg width="16" height="16" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.8" class="shrink-0">
                ...
                <a href="{{ route('admin.units.index') }}"
                    class="group relative flex items-center gap-3 px-3 py-2 rounded-xl text-[13px] font-medium transition-all duration-200
                        {{ str_starts_with($cur ?? '', 'admin.units') ? 'bg-[#060D26] text-white border-l-[3px] border-[#FF8A66]' : 'text-white/60 border-l-[3px] border-transparent hover:bg-white/[0.06] hover:text-[#FF8A66]' }}">
                    <svg width="16" height="16" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.8" class="shrink-0">
                ...
                <a href="{{ route('admin.catalogue.properties.index') }}"
                    class="group relative flex items-center gap-3 px-3 py-2 rounded-xl text-[13px] font-medium transition-all duration-200
                        {{ str_starts_with($cur ?? '', 'admin.catalogue.properties') ? 'bg-[#060D26] text-white border-l-[3px] border-[#FF8A66]' : 'text-white/60 border-l-[3px] border-transparent hover:bg-white/[0.06] hover:text-[#FF8A66]' }}">
                    <svg width="16" height="16" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.8" class="shrink-0">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M2.25 12l8.954-8.955c.44-.439 1.152-.439 1.591 0L21.75 12M4.5 9.75v10.125c0 .621.504 1.125 1.125 1.125H9.75v-4.875c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125V21h4.125c.621 0 1.125-.504 1.125-1.125V9.75M8.25 21h8.25" />
                    </svg>
                ...
                <a href="{{ route('admin.catalogue.units.index') }}"
                    class="group relative flex items-center gap-3 px-3 py-2 rounded-xl text-[13px] font-medium transition-all duration-200
                        {{ str_starts_with($cur ?? '', 'admin.catalogue.units') ? 'bg-[#060D26] text-white border-l-[3px] border-[#FF8A66]' : 'text-white/60 border-l-[3px] border-transparent hover:bg-white/[0.06] hover:text-[#FF8A66]' }}">
                    <svg width="16" height="16" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.8" class="shrink-0">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M3.75 6A2.25 2.25 0 016 3.75h2.25A2.25 2.25 0 0110.5 6v2.25a2.25 2.25 0 01-2.25 2.25H6a2.25 2.25 0 01-2.25-2.25V6zm0 9.75A2.25 2.25 0 016 13.5h2.25a2.25 2.25 0 012.25 2.25V18a2.25 2.25 0 01-2.25 2.25H6A2.25 2.25 0 013.75 18v-2.25zm9.75-9.75A2.25 2.25 0 0115.75 3.75H18A2.25 2.25 0 0120.25 6v2.25A2.25 2.25 0 0118 10.5h-2.25a2.25 2.25 0 01-2.25-2.25V6zm0 9.75a2.25 2.25 0 012.25-2.25H18a2.25 2.25 0 012.25 2.25V18A2.25 2.25 0 0118 20.25h-2.25A2.25 2.25 0 0113.5 18v-2.25z" />
                    </svg>
                ...
                <a href="{{ route('admin.reservations.index') }}"
                    class="group relative flex items-center gap-3 px-3 py-2 rounded-xl text-[13px] font-medium transition-all duration-200
                        {{ str_starts_with($cur ?? '', 'admin.reservations') ? 'bg-[#060D26] text-white border-l-[3px] border-[#FF8A66]' : 'text-white/60 border-l-[3px] border-transparent hover:bg-white/[0.06] hover:text-[#FF8A66]' }}">
                    <svg width="16" height="16" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.8" class="shrink-0">
                ...
                <a href="{{ route('admin.payments.index') }}"
                    class="group relative flex items-center gap-3 px-3 py-2 rounded-xl text-[13px] font-medium transition-all duration-200
                        {{ str_starts_with($cur ?? '', 'admin.payments') ? 'bg-[#060D26] text-white border-l-[3px] border-[#FF8A66]' : 'text-white/60 border-l-[3px] border-transparent hover:bg-white/[0.06] hover:text-[#FF8A66]' }}">
                    <svg width="16" height="16" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.8" class="shrink-0">
                ...
                <a href="{{ route('admin.payouts.index') }}"
                    class="group relative flex items-center gap-3 px-3 py-2 rounded-xl text-[13px] font-medium transition-all duration-200
                        {{ str_starts_with($cur ?? '', 'admin.payouts') ? 'bg-[#060D26] text-white border-l-[3px] border-[#FF8A66]' : 'text-white/60 border-l-[3px] border-transparent hover:bg-white/[0.06] hover:text-[#FF8A66]' }}">
                    <svg width="16" height="16" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.8" class="shrink-0">
                ...
                <a href="{{ route('admin.reviews.index') }}"
                    class="group relative flex items-center gap-3 px-3 py-2 rounded-xl text-[13px] font-medium transition-all duration-200
                        {{ str_starts_with($cur ?? '', 'admin.reviews') ? 'bg-[#060D26] text-white border-l-[3px] border-[#FF8A66]' : 'text-white/60 border-l-[3px] border-transparent hover:bg-white/[0.06] hover:text-[#FF8A66]' }}">
                    <svg width="16" height="16" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.8" class="shrink-0">
                ...
                <a href="{{ route('admin.reports.index') }}"
                    class="group relative flex items-center gap-3 px-3 py-2 rounded-xl text-[13px] font-medium transition-all duration-200
                        {{ str_starts_with($cur ?? '', 'admin.reports') ? 'bg-[#060D26] text-white border-l-[3px] border-[#FF8A66]' : 'text-white/60 border-l-[3px] border-transparent hover:bg-white/[0.06] hover:text-[#FF8A66]' }}">
                    <svg width="16" height="16" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.8" class="shrink-0">
                ...
                <a href="{{ route('admin.conversations.index') }}"
                    class="group relative flex items-center gap-3 px-3 py-2 rounded-xl text-[13px] font-medium transition-all duration-200
                        {{ str_starts_with($cur ?? '', 'admin.conversations') ? 'bg-[#060D26] text-white border-l-[3px] border-[#FF8A66]' : 'text-white/60 border-l-[3px] border-transparent hover:bg-white/[0.06] hover:text-[#FF8A66]' }}">
                    <svg width="16" height="16" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.8" class="shrink-0">
                ...
                <a href="{{ route('admin.report-analytics.index') }}"
                    class="group relative flex items-center gap-3 px-3 py-2 rounded-xl text-[13px] font-medium transition-all duration-200
                        {{ str_starts_with($cur ?? '', 'admin.report-analytics') ? 'bg-[#060D26] text-white border-l-[3px] border-[#FF8A66]' : 'text-white/60 border-l-[3px] border-transparent hover:bg-white/[0.06] hover:text-[#FF8A66]' }}">
                    <svg width="16" height="16" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.8" class="shrink-0">
                ...
                <a href="{{ route('admin.ratings.index') }}"
                    class="group relative flex items-center gap-3 px-3 py-2 rounded-xl text-[13px] font-medium transition-all duration-200
                        {{ str_starts_with($cur ?? '', 'admin.ratings') ? 'bg-[#060D26] text-white border-l-[3px] border-[#FF8A66]' : 'text-white/60 border-l-[3px] border-transparent hover:bg-white/[0.06] hover:text-[#FF8A66]' }}">
                ...
                <a href="{{ route('admin.settings.edit') }}"
                    class="group relative flex items-center gap-3 px-3 py-2 rounded-xl text-[13px] font-medium transition-all duration-200
                        {{ str_starts_with($cur ?? '', 'admin.settings') ? 'bg-[#060D26] text-white border-l-[3px] border-[#FF8A66]' : 'text-white/60 border-l-[3px] border-transparent hover:bg-white/[0.06] hover:text-[#FF8A66]' }}">
                    <svg width="16" height="16" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.8" class="shrink-0">
                ...
                <a href="{{ route('admin.audit-logs.index') }}"
                    class="group relative flex items-center gap-3 px-3 py-2 rounded-xl text-[13px] font-medium transition-all duration-200
                        {{ str_starts_with($cur ?? '', 'admin.audit-logs') ? 'bg-[#060D26] text-white border-l-[3px] border-[#FF8A66]' : 'text-white/60 border-l-[3px] border-transparent hover:bg-white/[0.06] hover:text-[#FF8A66]' }}">
                    <svg width="16" height="16" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.8" class="shrink-0">
                ...
                <a href="{{ route('admin.profile.edit') }}"
                    class="group relative flex items-center gap-3 px-3 py-2 rounded-xl text-[13px] font-medium transition-all duration-200
                        {{ str_starts_with($cur ?? '', 'admin.profile') ? 'bg-[#060D26] text-white border-l-[3px] border-[#FF8A66]' : 'text-white/60 border-l-[3px] border-transparent hover:bg-white/[0.06] hover:text-[#FF8A66]' }}">
                    <svg width="16" height="16" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.8" class="shrink-0">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M15.75 6a3.75 3.75 0 11-7.5 0 3.75 3.75 0 017.5 0zM4.501 20.118a7.5 7.5 0 0114.998 0A17.933 17.933 0 0112 21.75c-2.676 0-5.216-.584-7.499-1.632z" />
                    </svg>
