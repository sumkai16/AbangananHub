...
<body class="font-sans bg-[#F7F8FC] text-[#060D26] min-h-screen" x-data="{
    ...
    <div class="flex min-h-screen">
        ...
        <aside id="admin-sidebar" x-cloak
            ...
            <div class="flex items-center justify-between h-[64px] border-b border-white/[0.06] shrink-0 px-5">
                ...
                <a href="{{ route('notifications.index') }}" data-sidebar-label x-show="!sidebarCollapsed" x-cloak
                    ...
                    @if($unread > 0)
                        <span class="absolute top-1 right-1 w-2 h-2 rounded-full bg-[#EF4444] border-2 border-[#060D26]"></span>
                    @endif
            ...
            <nav class="flex-1 overflow-y-auto overflow-x-hidden px-3 py-4 space-y-0.5 scrollbar-thin">
                ...
                <a href="{{ route('notifications.index') }}" x-show="sidebarCollapsed" x-cloak
                    class="group relative flex items-center justify-center px-3 py-2 rounded-xl text-[13px] font-medium transition-all duration-200 mb-1
                ...
                <a href="{{ route('admin.dashboard') }}"
                    class="group relative flex items-center gap-3 px-3 py-2 rounded-xl text-[13px] font-medium transition-all duration-200 mb-3
                        {{ $cur === 'admin.dashboard' ? 'bg-[#060D26] text-white border-l-[3px] border-[#DA8E77]' : 'text-white/60 border-l-[3px] border-transparent hover:bg-white/[0.06] hover:text-[#DA8E77]' }}">
                    <svg width="16" height="16" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.8" class="shrink-0">
                ...
                <a href="{{ route('admin.users.index') }}"
                    class="group relative flex items-center gap-3 px-3 py-2 rounded-xl text-[13px] font-medium transition-all duration-200
                        {{ ($cur === 'admin.users.index' && !$usersRoleFilter) || $cur === 'admin.users.show' ? 'bg-[#060D26] text-white border-l-[3px] border-[#DA8E77]' : 'text-white/60 border-l-[3px] border-transparent hover:bg-white/[0.06] hover:text-[#DA8E77]' }}">
                    <svg width="16" height="16" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.8" class="shrink-0">
                ...
                <a href="{{ route('admin.users.index', ['role' => 'Landlord']) }}"
                    class="group relative flex items-center gap-3 px-3 py-2 rounded-xl text-[13px] font-medium transition-all duration-200
                        {{ $cur === 'admin.users.index' && $usersRoleFilter === 'Landlord' ? 'bg-[#060D26] text-white border-l-[3px] border-[#DA8E77]' : 'text-white/60 border-l-[3px] border-transparent hover:bg-white/[0.06] hover:text-[#DA8E77]' }}">
                    <svg width="16" height="16" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.8" class="shrink-0">
                ...
                <a href="{{ route('admin.users.index', ['role' => 'Tenant']) }}"
                    class="group relative flex items-center gap-3 px-3 py-2 rounded-xl text-[13px] font-medium transition-all duration-200
                        {{ $cur === 'admin.users.index' && $usersRoleFilter === 'Tenant' ? 'bg-[#060D26] text-white border-l-[3px] border-[#DA8E77]' : 'text-white/60 border-l-[3px] border-transparent hover:bg-white/[0.06] hover:text-[#DA8E77]' }}">
                    <svg width="16" height="16" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.8" class="shrink-0">
                ...
                <a href="{{ route('admin.verifications.index') }}"
                    class="group relative flex items-center gap-3 px-3 py-2 rounded-xl text-[13px] font-medium transition-all duration-200
                        {{ str_starts_with($cur ?? '', 'admin.verifications') ? 'bg-[#060D26] text-white border-l-[3px] border-[#DA8E77]' : 'text-white/60 border-l-[3px] border-transparent hover:bg-white/[0.06] hover:text-[#DA8E77]' }}">
                    <svg width="16" height="16" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.8" class="shrink-0">
                ...
                <a href="{{ route('admin.listings.approval') }}"
                    class="group relative flex items-center gap-3 px-3 py-2 rounded-xl text-[13px] font-medium transition-all duration-200
                        {{ $cur === 'admin.listings.approval' ? 'bg-[#060D26] text-white border-l-[3px] border-[#DA8E77]' : 'text-white/60 border-l-[3px] border-transparent hover:bg-white/[0.06] hover:text-[#DA8E77]' }}">
                    <svg width="16" height="16" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.8" class="shrink-0">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M2.25 12l8.954-8.955c.44-.439 1.152-.439 1.591 0L21.75 12M4.5 9.75v10.125c0 .621.504 1.125 1.125 1.125H9.75v-4.875c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125V21h4.125c.621 0 1.125-.504 1.125-1.125V9.75M8.25 21h8.25" />
                    </svg>
                ...
                <a href="{{ route('admin.documents.index') }}"
                    class="group relative flex items-center gap-3 px-3 py-2 rounded-xl text-[13px] font-medium transition-all duration-200
                        {{ str_starts_with($cur ?? '', 'admin.documents') ? 'bg-[#060D26] text-white border-l-[3px] border-[#DA8E77]' : 'text-white/60 border-l-[3px] border-transparent hover:bg-white/[0.06] hover:text-[#DA8E77]' }}">
                    <svg width="16" height="16" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.8" class="shrink-0">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M19.5 14.25v-2.625a3.375 3.375 0 00-3.375-3.375h-1.5A1.125 1.125 0 0113.5 7.125v-1.5a3.375 3.375 0 00-3.375-3.375H8.25m2.25 0H5.625c-.621 0-1.125.504-1.125 1.125v17.25c0 .621.504 1.125 1.125 1.125h12.75c.621 0 1.125-.504 1.125-1.125V11.25a9 9 0 00-9-9z" />
                    </svg>
                    <span data-sidebar-label x-show="!sidebarCollapsed" x-cloak class="whitespace-nowrap flex-1">Property Documents</span>
                    <span x-show="sidebarCollapsed" x-cloak
                        class="pointer-events-none absolute left-full ml-3 top-1/2 -translate-y-1/2 whitespace-nowrap rounded-lg bg-[#1e293b] border border-white/10 px-2.5 py-1.5 text-xs font-medium text-white opacity-0 group-hover:opacity-100 transition-opacity z-50 shadow-xl">
                        Property Documents
                    </span>
                ...
                <a href="{{ route('admin.units.index') }}"
                    class="group relative flex items-center gap-3 px-3 py-2 rounded-xl text-[13px] font-medium transition-all duration-200
                        {{ str_starts_with($cur ?? '', 'admin.units') ? 'bg-[#060D26] text-white border-l-[3px] border-[#DA8E77]' : 'text-white/60 border-l-[3px] border-transparent hover:bg-white/[0.06] hover:text-[#DA8E77]' }}">
                    <svg width="16" height="16" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.8" class="shrink-0">
                ...
                <a href="{{ route('admin.catalogue.properties.index') }}"
                    class="group relative flex items-center gap-3 px-3 py-2 rounded-xl text-[13px] font-medium transition-all duration-200
                        {{ str_starts_with($cur ?? '', 'admin.catalogue.properties') ? 'bg-[#060D26] text-white border-l-[3px] border-[#DA8E77]' : 'text-white/60 border-l-[3px] border-transparent hover:bg-white/[0.06] hover:text-[#DA8E77]' }}">
                    <svg width="16" height="16" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.8" class="shrink-0">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M2.25 12l8.954-8.955c.44-.439 1.152-.439 1.591 0L21.75 12M4.5 9.75v10.125c0 .621.504 1.125 1.125 1.125H9.75v-4.875c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125V21h4.125c.621 0 1.125-.504 1.125-1.125V9.75M8.25 21h8.25" />
                    </svg>
                ...
                <a href="{{ route('admin.catalogue.units.index') }}"
                    class="group relative flex items-center gap-3 px-3 py-2 rounded-xl text-[13px] font-medium transition-all duration-200
                        {{ str_starts_with($cur ?? '', 'admin.catalogue.units') ? 'bg-[#060D26] text-white border-l-[3px] border-[#DA8E77]' : 'text-white/60 border-l-[3px] border-transparent hover:bg-white/[0.06] hover:text-[#DA8E77]' }}">
                    <svg width="16" height="16" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.8" class="shrink-0">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M3.75 6A2.25 2.25 0 016 3.75h2.25A2.25 2.25 0 0110.5 6v2.25a2.25 2.25 0 01-2.25 2.25H6a2.25 2.25 0 01-2.25-2.25V6zm0 9.75A2.25 2.25 0 016 13.5h2.25a2.25 2.25 0 012.25 2.25V18a2.25 2.25 0 01-2.25 2.25H6A2.25 2.25 0 013.75 18v-2.25zm9.75-9.75A2.25 2.25 0 0115.75 3.75H18A2.25 2.25 0 0120.25 6v2.25A2.25 2.25 0 0118 10.5h-2.25a2.25 2.25 0 01-2.25-2.25V6zm0 9.75a2.25 2.25 0 012.25-2.25H18a2.25 2.25 0 012.25 2.25V18A2.25 2.25 0 0118 20.25h-2.25A2.25 2.25 0 0113.5 18v-2.25z" />
                    </svg>
                ...
                <a href="{{ route('admin.reservations.index') }}"
                    class="group relative flex items-center gap-3 px-3 py-2 rounded-xl text-[13px] font-medium transition-all duration-200
                        {{ str_starts_with($cur ?? '', 'admin.reservations') ? 'bg-[#060D26] text-white border-l-[3px] border-[#DA8E77]' : 'text-white/60 border-l-[3px] border-transparent hover:bg-white/[0.06] hover:text-[#DA8E77]' }}">
                    <svg width="16" height="16" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.8" class="shrink-0">
                ...
                {{-- Inquiries and Messages were listed here as "Soon" but both already exist:
                     an inquiry is rental_status[0] on the Reservations index (?status=Inquiry),
                     and Messages was a duplicate of Conversations under Content & Reviews. --}}
                ...
                <a href="{{ route('admin.payments.index') }}"
                    class="group relative flex items-center gap-3 px-3 py-2 rounded-xl text-[13px] font-medium transition-all duration-200
                        {{ str_starts_with($cur ?? '', 'admin.payments') ? 'bg-[#060D26] text-white border-l-[3px] border-[#DA8E77]' : 'text-white/60 border-l-[3px] border-transparent hover:bg-white/[0.06] hover:text-[#DA8E77]' }}">
                    <svg width="16" height="16" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.8" class="shrink-0">
                ...
                <a href="{{ route('admin.payouts.index') }}"
                    class="group relative flex items-center gap-3 px-3 py-2 rounded-xl text-[13px] font-medium transition-all duration-200
                        {{ str_starts_with($cur ?? '', 'admin.payouts') ? 'bg-[#060D26] text-white border-l-[3px] border-[#DA8E77]' : 'text-white/60 border-l-[3px] border-transparent hover:bg-white/[0.06] hover:text-[#DA8E77]' }}">
                    <svg width="16" height="16" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.8" class="shrink-0">
                ...
                <a href="{{ route('admin.reviews.index') }}"
                    class="group relative flex items-center gap-3 px-3 py-2 rounded-xl text-[13px] font-medium transition-all duration-200
                        {{ str_starts_with($cur ?? '', 'admin.reviews') ? 'bg-[#060D26] text-white border-l-[3px] border-[#DA8E77]' : 'text-white/60 border-l-[3px] border-transparent hover:bg-white/[0.06] hover:text-[#DA8E77]' }}">
                    <svg width="16" height="16" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.8" class="shrink-0">
                ...
                <a href="{{ route('admin.reports.index') }}"
                    class="group relative flex items-center gap-3 px-3 py-2 rounded-xl text-[13px] font-medium transition-all duration-200
                        {{ str_starts_with($cur ?? '', 'admin.reports') ? 'bg-[#060D26] text-white border-l-[3px] border-[#DA8E77]' : 'text-white/60 border-l-[3px] border-transparent hover:bg-white/[0.06] hover:text-[#DA8E77]' }}">
                    <svg width="16" height="16" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.8" class="shrink-0">
                ...
                <a href="{{ route('admin.conversations.index') }}"
                    class="group relative flex items-center gap-3 px-3 py-2 rounded-xl text-[13px] font-medium transition-all duration-200
                        {{ str_starts_with($cur ?? '', 'admin.conversations') ? 'bg-[#060D26] text-white border-l-[3px] border-[#DA8E77]' : 'text-white/60 border-l-[3px] border-transparent hover:bg-white/[0.06] hover:text-[#DA8E77]' }}">
                    <svg width="16" height="16" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.8" class="shrink-0">
                ...
                <a href="{{ route('admin.report-analytics.index') }}"
                    class="group relative flex items-center gap-3 px-3 py-2 rounded-xl text-[13px] font-medium transition-all duration-200
                        {{ str_starts_with($cur ?? '', 'admin.report-analytics') ? 'bg-[#060D26] text-white border-l-[3px] border-[#DA8E77]' : 'text-white/60 border-l-[3px] border-transparent hover:bg-white/[0.06] hover:text-[#DA8E77]' }}">
                    <svg width="16" height="16" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.8" class="shrink-0">
                ...
                <a href="{{ route('admin.ratings.index') }}"
                    class="group relative flex items-center gap-3 px-3 py-2 rounded-xl text-[13px] font-medium transition-all duration-200
                        {{ str_starts_with($cur ?? '', 'admin.ratings') ? 'bg-[#060D26] text-white border-l-[3px] border-[#DA8E77]' : 'text-white/60 border-l-[3px] border-transparent hover:bg-white/[0.06] hover:text-[#DA8E77]' }}">
                ...
                {{-- A third "Reports" was listed here as "Soon". Removed: abuse reports live under
                     Content & Reviews, and Analytics above already exports properties/reservations/users. --}}
                ...
                <a href="{{ route('admin.settings.edit') }}"
                    class="group relative flex items-center gap-3 px-3 py-2 rounded-xl text-[13px] font-medium transition-all duration-200
                        {{ str_starts_with($cur ?? '', 'admin.settings') ? 'bg-[#060D26] text-white border-l-[3px] border-[#DA8E77]' : 'text-white/60 border-l-[3px] border-transparent hover:bg-white/[0.06] hover:text-[#DA8E77]' }}">
                    <svg width="16" height="16" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.8" class="shrink-0">
                    ...
                    <span data-sidebar-label x-show="!sidebarCollapsed" x-cloak class="whitespace-nowrap flex-1">System Settings</span>
                    <span x-show="sidebarCollapsed" x-cloak
                        class="pointer-events-none absolute left-full ml-3 top-1/2 -translate-y-1/2 whitespace-nowrap rounded-lg bg-[#1e293b] border border-white/10 px-2.5 py-1.5 text-xs font-medium text-white opacity-0 group-hover:opacity-100 transition-opacity z-50 shadow-xl">
                        System Settings
                    </span>
                ...
                <a href="{{ route('admin.audit-logs.index') }}"
                    class="group relative flex items-center gap-3 px-3 py-2 rounded-xl text-[13px] font-medium transition-all duration-200
                        {{ str_starts_with($cur ?? '', 'admin.audit-logs') ? 'bg-[#060D26] text-white border-l-[3px] border-[#DA8E77]' : 'text-white/60 border-l-[3px] border-transparent hover:bg-white/[0.06] hover:text-[#DA8E77]' }}">
                    <svg width="16" height="16" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.8" class="shrink-0">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M9 12h3.75M9 15h3.75M9 18h3.75m3 .75H18a2.25 2.25 0 002.25-2.25V6.108c0-1.135-.845-2.098-1.976-2.192a48.424 48.424 0 00-1.123-.08m-5.801 0c-.065.21-.1.433-.1.664 0 .414.336.75.75.75h4.5a.75.75 0 00.75-.75 2.25 2.25 0 00-.1-.664m-5.8 0A2.251 2.251 0 0113.5 2.25H15c1.012 0 1.867.668 2.15 1.586m-5.8 0c-.376.023-.75.05-1.124.08C9.095 4.01 8.25 4.973 8.25 6.108V8.25m0 0H4.875c-.621 0-1.125.504-1.125 1.125v11.25c0 .621.504 1.125 1.125 1.125h9.75c.621 0 1.125-.504 1.125-1.125V9.375c0-.621-.504-1.125-1.125-1.125H8.25zM6.75 12h.008v.008H6.75V12zm0 3h.008v.008H6.75V15zm0 3h.008v.008H6.75V18z" />
                    </svg>
                    <span data-sidebar-label x-show="!sidebarCollapsed" x-cloak class="whitespace-nowrap flex-1">Audit Logs</span>
                    <span x-show="sidebarCollapsed" x-cloak
                        class="pointer-events-none absolute left-full ml-3 top-1/2 -translate-y-1/2 whitespace-nowrap rounded-lg bg-[#1e293b] border border-white/10 px-2.5 py-1.5 text-xs font-medium text-white opacity-0 group-hover:opacity-100 transition-opacity z-50 shadow-xl">
                        Audit Logs
                    </span>
                ...
                <a href="{{ route('admin.profile.edit') }}"
                    class="group relative flex items-center gap-3 px-3 py-2 rounded-xl text-[13px] font-medium transition-all duration-200
                        {{ str_starts_with($cur ?? '', 'admin.profile') ? 'bg-[#060D26] text-white border-l-[3px] border-[#DA8E77]' : 'text-white/60 border-l-[3px] border-transparent hover:bg-white/[0.06] hover:text-[#DA8E77]' }}">
                    <svg width="16" height="16" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.8" class="shrink-0">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M15.75 6a3.75 3.75 0 11-7.5 0 3.75 3.75 0 017.5 0zM4.501 20.118a7.5 7.5 0 0114.998 0A17.933 17.933 0 0112 21.75c-2.676 0-5.216-.584-7.499-1.632z" />
                    </svg>
        ...
        <div id="admin-main" :class="sidebarCollapsed ? 'lg:ml-20' : 'lg:ml-64'"
            ...
            <div class="lg:hidden flex items-center justify-between px-4 py-3 bg-white border-b border-[#E2E4EC] sticky top-0 z-30">
                <button @click="sidebarOpen = !sidebarOpen"
                    class="w-9 h-9 flex items-center justify-center rounded-xl hover:bg-[#ECEEF6] text-[#5B6A8E] transition-colors">
