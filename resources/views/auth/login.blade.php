    ...
    <div class="w-full min-h-screen bg-[#F7FCFC] flex flex-col items-center px-4 py-10 lg:py-14">
        <div class="w-full max-w-sm sm:max-w-md bg-white rounded-2xl border border-[#E2E8F0]/80 p-6 lg:p-8 shadow-xl shadow-[#1F2937]/[0.04] transition-all duration-300">
            ...
            <div class="mb-5">
                ...
                <h2 class="text-lg sm:text-xl font-black text-[#156F8C] tracking-tight">Welcome Back!</h2>
            ...
            <form method="POST" action="{{ route('login') }}" class="space-y-3.5">
                ...
                <div class="flex items-center justify-between pt-0.5">
                    <label class="flex items-center gap-2 text-xs text-[#5E6968] font-semibold cursor-pointer select-none">
                        <input type="checkbox" name="remember" class="rounded border-[#E2E8F0] text-[#2AA7A1] focus:ring-[#2AA7A1] transition-colors w-3.5 h-3.5" />
                        Remember me
                    </label>
