    ...
    <div class="w-full min-h-screen lg:h-screen bg-gradient-to-br from-slate-50 via-blue-50/30 to-slate-100 flex flex-col justify-center items-center px-4 py-4 lg:py-2 overflow-y-auto lg:overflow-hidden">
        <div class="w-full max-w-lg bg-white rounded-2xl border border-[#E2E8F0]/80 p-5 sm:px-6 sm:py-5 shadow-xl shadow-[#1F2937]/[0.04] transition-all duration-300">
            ...
            <div class="mb-4">
                ...
                <h2 class="text-xl font-black text-[#156F8C] tracking-tight">Create Your <span class="bg-gradient-to-r from-[#2AA7A1] to-[#2AA7A1] bg-clip-text text-transparent">Account</span></h2>
            ...
            <form method="POST" action="{{ route('register') }}" class="space-y-3">
                ...
                <div>
                    <label for="password" class="block text-xs font-bold text-[#156F8C] mb-0.5">Password</label>
                    <div class="relative">
                ...
                <div>
                    <label for="password_confirmation" class="block text-xs font-bold text-[#156F8C] mb-0.5">Confirm Password</label>
                    <div class="relative">
