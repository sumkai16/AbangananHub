...
.abg-hero-actions {
    ...
    position: relative; z-index: 1; flex-direction: column; align-items: flex-end;
}
.abg-btn-white {
...
.abg-see-all {
    ...
    border: 1.5px solid #D7E8F3; border-radius: 10px; transition: background 0.15s;
}
.abg-see-all:hover { background: #EEF5FF; }

/* ── FILTER BAR ── */
.abg-filter-bar { display: flex; align-items: center; gap: 10px; margin-bottom: 18px; flex-wrap: wrap; }
...
.abg-resv-card:hover { box-shadow: 0 6px 24px rgba(40,108,210,0.09); border-color: #D7E8F3; transform: translateY(-1px); }
.abg-resv-thumb {
...
.abg-qa-card {
    ...
    padding: 22px; box-shadow: 0 2px 8px rgba(0,0,0,0.04); margin-bottom: 18px;
}
...
.abg-qa-item {
    ...
    margin-bottom: 8px; background: #FAFBFC; transition: all 0.15s;
}
.abg-qa-item:last-child { margin-bottom: 0; }
.abg-qa-item:hover { border-color: #D7E8F3; background: #F0F6FF; color: #286CD2; transform: translateX(2px); }
...
.abg-act-dot { width: 8px; height: 8px; border-radius: 50%; flex-shrink: 0; margin-top: 5px; }
    ...
    <div class="abg-stats">
        ...
        <div class="abg-stat">
            ...
            <div class="abg-stat-icon" style="background:linear-gradient(135deg,#FFF4EE,#FFE5D8);">
                <svg width="18" height="18" fill="none" viewBox="0 0 24 24" stroke="#BD5434" stroke-width="2.5"><path stroke-linecap="round" stroke-linejoin="round" d="M3 21v-4m0 0V5a2 2 0 012-2h6.5l1 1H21l-3 6 3 6h-8.5l-1-1H5a2 2 0 00-2 2zm9-13.5V9"/></svg>
            </div>
    ...
    <div id="reservations">
        ...
        <div class="abg-resv-list" id="reservations-list">
            @forelse($reservations as $reservation)
                ...
                @endphp
                <div class="abg-resv-card reservation-row"
            ...
            <div style="margin-top:24px;">
                ...
                <div class="abg-activity">
                    ...
                    @empty
                        <div class="abg-act-item">
                            <div class="abg-act-dot" style="background:#286CD2;"></div>
                            <div class="abg-act-text">Welcome to <strong>AbangananHub</strong>! Start by browsing verified properties in Cebu.</div>
            ...
            <div>
                ...
                <div class="abg-host-card">
                    ...
                    <div class="abg-host-perks">
                        <div class="abg-host-perk"><div class="abg-host-perk-dot"></div>Submit government ID for verification</div>
                        <div class="abg-host-perk"><div class="abg-host-perk-dot"></div>Admin reviews and approves your account</div>
                        <div class="abg-host-perk"><div class="abg-host-perk-dot"></div>Create verified listings tenants can trust</div>
                        <div class="abg-host-perk"><div class="abg-host-perk-dot"></div>Manage reservations and tenant inquiries</div>
                    </div>
