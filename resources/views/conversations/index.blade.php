...
<div class="max-w-4xl mx-auto px-4 py-10">
    ...
    <div class="flex items-center justify-between mb-8">
        <div>
            ...
            <p class="text-sm text-gray-500 mt-1">Manage your active inquiries and conversation threads regarding properties.</p>
        </div>
        <span class="bg-blue-50 text-blue-600 text-xs font-bold px-3 py-1.5 rounded-xl border border-blue-100 shadow-sm">
    ...
    <div class="bg-white border border-gray-100 rounded-2xl shadow-sm overflow-hidden">
               ...
               class="group block border-b border-gray-100 last:border-b-0 p-5 hover:bg-blue-50/20 transition duration-200">
                <div class="flex items-center justify-between gap-4">
                    ...
                    <div class="flex items-center space-x-4 min-w-0 flex-1">
                        ...
                        <div class="w-12 h-12 rounded-full bg-blue-600 text-white flex items-center justify-center font-bold text-base shadow-sm shrink-0 transition group-hover:scale-105">
                    ...
                    <div class="flex items-center space-x-4 shrink-0">
                        <div class="text-right hidden sm:block">
                            <span class="inline-flex items-center px-3 py-1.5 rounded-xl text-xs font-semibold bg-gray-50 text-gray-600 border border-gray-100 max-w-[220px] truncate">
                                <svg class="w-3.5 h-3.5 text-gray-400 mr-2 shrink-0" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                        ...
                        <svg class="w-5 h-5 text-gray-300 group-hover:text-blue-500 transform group-hover:translate-x-1 transition" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24">
        ...
        @empty
            ...
            <div class="p-16 text-center">
                ...
                <p class="text-sm text-gray-500 mt-1 max-w-sm mx-auto">When you drop inquiries to listing landlords, your real-time secure room interactions will manifest here.</p>
            </div>
        @endforelse
    </div>
</div>
