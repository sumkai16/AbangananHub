...
<div class="min-h-screen bg-gray-50/50 py-12">
    <div class="max-w-6xl mx-auto px-6 lg:px-8">
        ...
        <div class="flex flex-col gap-4 border-b border-gray-150 pb-6 mb-8">
            <a href="{{ route('landlord.listings.index') }}" class="inline-flex items-center gap-2 text-[13px] font-bold text-gray-400 hover:text-[#286CD2] transition-colors w-fit">
            ...
            <div>
                <h1 class="text-3xl font-extrabold text-[#1A1A2E] tracking-tight">List a New Property</h1>
        ...
        @if($errors->any())
            <div class="mb-8 p-5 bg-red-50 border border-red-100 rounded-3xl flex gap-4">
                ...
                <div>
                    <h5 class="text-[14px] font-bold text-[#1A1A2E]">Please fix the following:</h5>
        ...
        <form action="{{ route('properties.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
                ...
                <div class="lg:col-span-7 bg-white border border-gray-100 rounded-3xl p-8 shadow-sm space-y-6">
                    ...
                    <h3 class="text-[16px] font-bold text-[#1A1A2E] border-b border-gray-50 pb-4">Property details</h3>
                    ...
                    <div>
                        ...
                        <input type="text" name="title" value="{{ old('title') }}" minlength="10" maxlength="150"
                            class="w-full h-12 px-4 rounded-2xl border @error('title') border-red-300 @else border-gray-200 @enderror text-[14px] font-medium text-[#1A1A2E] focus:outline-none focus:ring-2 focus:ring-[#286CD2]/20 focus:border-[#286CD2] transition-all"
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div>
                            ...
                            <select name="property_type"
                                class="w-full h-12 px-4 rounded-2xl border @error('property_type') border-red-300 @else border-gray-200 @enderror text-[14px] font-medium text-[#1A1A2E] focus:outline-none focus:ring-2 focus:ring-[#286CD2]/20 focus:border-[#286CD2] transition-all" required>
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="number" step="0.01" min="500" max="999999" name="rental_fee" value="{{ old('rental_fee') }}"
                                    class="w-full h-12 pl-8 pr-4 rounded-2xl border @error('rental_fee') border-red-300 @else border-gray-200 @enderror text-[14px] font-bold text-[#1A1A2E] focus:outline-none focus:ring-2 focus:ring-[#286CD2]/20 focus:border-[#286CD2] transition-all"
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 border-t border-gray-50 pt-5">
                        <div>
                            ...
                            <input type="number" name="occupancy_limit" value="{{ old('occupancy_limit', 1) }}" min="1" max="100"
                                class="w-full h-12 px-4 rounded-2xl border @error('occupancy_limit') border-red-300 @else border-gray-200 @enderror text-[14px] font-medium text-[#1A1A2E] focus:outline-none focus:ring-2 focus:ring-[#286CD2]/20 focus:border-[#286CD2] transition-all" required>
                        ...
                        <div>
                            ...
                            <input type="number" step="any" min="-90" max="90" name="latitude" value="{{ old('latitude') }}" placeholder="10.3157"
                                class="w-full h-12 px-4 rounded-2xl border @error('latitude') border-red-300 @else border-gray-200 @enderror text-[14px] text-[#1A1A2E] focus:outline-none focus:ring-2 focus:ring-[#286CD2]/20 focus:border-[#286CD2] transition-all">
                        ...
                        <div>
                            ...
                            <input type="number" step="any" min="-180" max="180" name="longitude" value="{{ old('longitude') }}" placeholder="123.8854"
                                class="w-full h-12 px-4 rounded-2xl border @error('longitude') border-red-300 @else border-gray-200 @enderror text-[14px] text-[#1A1A2E] focus:outline-none focus:ring-2 focus:ring-[#286CD2]/20 focus:border-[#286CD2] transition-all">
                    ...
                    <div>
                        ...
                        <input type="text" name="address" value="{{ old('address') }}" minlength="10" maxlength="255"
                            class="w-full h-12 px-4 rounded-2xl border @error('address') border-red-300 @else border-gray-200 @enderror text-[14px] font-medium text-[#1A1A2E] focus:outline-none focus:ring-2 focus:ring-[#286CD2]/20 focus:border-[#286CD2] transition-all"
                    ...
                    <div>
                        ...
                        <textarea name="description" rows="6" minlength="20" maxlength="3000"
                            class="w-full p-4 rounded-2xl border @error('description') border-red-300 @else border-gray-200 @enderror text-[14px] text-[#1A1A2E] leading-relaxed focus:outline-none focus:ring-2 focus:ring-[#286CD2]/20 focus:border-[#286CD2] transition-all"
                ...
                <div class="lg:col-span-5">
                    <div class="sticky top-8 space-y-6">
                        ...
                        <div class="bg-white border border-gray-100 rounded-3xl p-6 shadow-sm space-y-4">
                            ...
                            <div class="border-2 border-dashed @error('photos') border-red-200 @else border-gray-200 @enderror hover:border-[#286CD2] rounded-3xl p-6 bg-gray-50/50 text-center transition-colors group">
                                <label class="cursor-pointer block">
                                    <div class="w-12 h-12 rounded-2xl bg-white shadow-sm border border-gray-100 flex items-center justify-center mx-auto mb-3 text-gray-400 group-hover:text-[#286CD2] transition-all">
                                        <svg class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.8">
                                            <path stroke-linecap="round" stroke-linejoin="round" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z"/>
                                        </svg>
                                    </div>
                                    <span id="upload-label" data-default-label="Select photos to upload" class="text-[13.5px] font-bold text-[#1A1A2E] group-hover:text-[#286CD2] transition-colors">Select photos to upload</span>
                        ...
                        <div class="rounded-3xl bg-blue-50/50 border border-blue-100 p-5">
                            <p class="text-sm font-bold text-[#1A1A2E]">Heads up</p>
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <button type="submit" class="w-2/3 h-12 rounded-full bg-[#286CD2] text-white font-bold text-[13.5px] shadow-sm hover:bg-[#1e5bb8] transition-all duration-300">
                                Create Listing
                            </button>
                        </div>
                    </div>
