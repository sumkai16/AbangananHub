...
@section('content')
    <div class="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 py-10 pb-16 min-h-[60vh]">
        <div class="flex items-center gap-3">
            <span class="inline-flex items-center gap-2 font-['Plus_Jakarta_Sans',_Inter,_sans-serif] text-[10.5px] font-bold uppercase tracking-[0.14em] text-[#5B6A8E]"><span class="w-1.5 h-1.5 rounded-full bg-[#DA8E77] shadow-[0_0_0_3px_rgba(255,138,102,0.25)]"></span>All areas</span>
        ...
        <h1 class="mt-2 mb-6 font-['Plus_Jakarta_Sans',_Inter,_sans-serif] text-[26px] sm:text-[34px] font-extrabold leading-tight tracking-tight text-[#060D26]">Every neighborhood, <span class="text-[#5B6A8E]">one place.</span></h1>
