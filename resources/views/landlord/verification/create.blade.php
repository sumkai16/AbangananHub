            ...
            <form method="POST" action="{{ route('landlord.verification.store') }}" enctype="multipart/form-data"
                ...
                <div x-show="step === 0" x-transition:enter.duration.200ms class="max-w-xl mx-auto">
                    ...
                    <button type="button" @click="nextStep()"
                        class="w-full py-3 rounded-xl text-sm font-semibold text-[#060D26] bg-[#DA8E77] hover:bg-[#C97A61] transition-all duration-150">
                        Get started
                    </button>
                ...
                <div x-show="step === 1" x-transition:enter.duration.200ms class="max-w-2xl">
                    ...
                    <div class="mt-7 pt-5 border-t border-[#E2E4EC] flex items-center gap-3">
                        <button type="button" @click="nextStep()" :disabled="!idType"
                            class="ml-auto px-9 py-3 rounded-xl text-sm font-semibold text-[#060D26] bg-[#DA8E77] hover:bg-[#C97A61] transition-all duration-150 disabled:opacity-40 disabled:cursor-not-allowed disabled:hover:brightness-100">
                            Continue
                        </button>
                    </div>
                </div>
                    ...
                    <div x-show="idCapturePhase === 'choose'" class="mt-6 max-w-xl">
                        ...
                        <div class="mt-7 pt-5 border-t border-[#E2E4EC] flex items-center gap-3">
                            ...
                            <button type="button" @click="startIdCapture()"
                                class="ml-auto inline-flex items-center justify-center gap-2 px-7 py-3 rounded-xl text-sm font-semibold text-[#060D26] bg-[#DA8E77] hover:bg-[#C97A61] transition-all duration-150">
                ...
                <div x-show="step === 5" x-transition:enter.duration.200ms class="max-w-4xl">
                            ...
                            <div x-show="ocrResult" class="space-y-2">
                                ...
                                <div class="flex items-center gap-2 px-3 py-2.5 rounded-xl"
                                    ...
                                    <svg class="w-4 h-4 shrink-0"
                                        ...
                                        xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                        stroke-width="1.5" stroke="currentColor">
                                        <path x-show="ocrResult?.type_match === 'match'" stroke-linecap="round"
                    ...
                    <div class="mt-7 pt-5 border-t border-[#E2E4EC] flex items-center gap-3">
                        ...
                        <button type="submit" :disabled="submitting"
                            class="ml-auto inline-flex items-center justify-center gap-2 px-9 py-3 rounded-xl text-sm font-semibold text-[#060D26] bg-[#DA8E77] hover:bg-[#C97A61] transition-all duration-150 disabled:opacity-60 disabled:cursor-not-allowed">
