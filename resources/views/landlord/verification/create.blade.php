            ...
            <form method="POST" action="{{ route('landlord.verification.store') }}" enctype="multipart/form-data"
                ...
                <div x-show="step === 3" x-transition:enter.duration.200ms>
                        ...
                        <div class="bg-white rounded-xl border border-[#E2E8F0] p-5">
                            ...
                            <div x-show="selfieCaptureMethod === 'camera'" class="relative">
                                <div class="relative rounded-xl overflow-hidden bg-black aspect-[3/4] max-w-sm mx-auto">
                                    ...
                                    {{-- Guide ring — color changes based on liveness state --}}
                                    <div class="absolute inset-0 flex items-center justify-center pointer-events-none">
                                        <div class="w-[55%] h-[50%] rounded-full border-[3px] transition-colors duration-300"
                                            :style="'border-color: ' + livenessGuideColor"></div>
                                    </div>
                                    ...
                                    {{-- Loading overlay --}}
                                    <div x-show="livenessLoading"
                                        class="absolute inset-0 bg-black/40 flex flex-col items-center justify-center pointer-events-none">
                                        <svg class="animate-spin h-8 w-8 text-white mb-2" xmlns="http://www.w3.org/2000/svg"
                                            fill="none" viewBox="0 0 24 24">
                                            <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor"
                                                stroke-width="4"></circle>
                                            <path class="opacity-75" fill="currentColor"
                                        ...
                                        <span class="text-sm text-white">Preparing face detection...</span>
                                    </div>
                                    ...
                                    <div x-show="livenessPassed&& countdownValue === 0"
                                            ...
                                            <div class="w-16 h-16 rounded-full bg-[#22C55E] flex items-center justify-center">
                                                <svg class="w-8 h-8 text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2.5" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="m4.5 12.75 6 6 9-13.5" /></svg>
                                            </div>
                                        </div>

                                        {{-- Countdown overlay --}}
                                        <div x-show="countdownValue > 0"
                                            class="absolute inset-0 bg-black/30 flex items-center justify-center pointer-events-none">
                                            <span class="text-7xl font-bold text-white drop-shadow-lg" x-text="countdownValue"></span>
                                        </div>
                                    </div>
                                                ...
                                                <div class="text-center">
                                                    <div class="w-8 h-8 rounded-full flex items-center justify-center mx-auto mb-1 transition-colors duration-300"
                                                        ...
                                                        <template x-if="livenessCompleted[idx]">
                                                            <svg class="w-4 h-4 text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2.5" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="m4.5 12.75 6 6 9-13.5" /></svg>
                                                        </template>
                                    ...
                                    <div x-show="livenessError" class="mt-4">
                                        <div class="p-3 rounded-xl bg-amber-50 mb-3">
                                            <p class="text-xs text-[#1F2937]">Face detection couldn't load. You can take a regular selfie instead — our team will verify manually.</p>
                                        </div>
                                        <div class="flex justify-center">
                                            <button type="button" @click="skipLiveness(); capturePhoto('selfie')" :disabled="!cameraActive"
                                                class="inline-flex items-center gap-2 px-6 py-2.5 rounded-xl text-sm font-semibold text-white bg-[#FF8A65] hover:brightness-95 transition-all duration-150 disabled:opacity-40 disabled:cursor-not-allowed">
                                                @include('components.icons.camera')
                                                Take selfie
                                            </button>
                                    ...
                                    <div x-show="!livenessActive && !livenessLoading && !livenessError && !livenessPassed" class="mt-4 flex justify-center">
                                ...
                                <div x-show="selfieCaptureMethod === 'upload'">
                                    <label class="flex flex-col items-center justify-center w-full aspect-[3/4] max-w-sm mx-auto rounded-xl border-2 border-dashed border-[#E2E8F0] hover:border-[#2AA7A1] bg-[#F7FCFC] cursor-pointer transition-colors duration-150">
                                        <svg class="w-10 h-10 text-[#64748B] mb-2" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                                            <path stroke-linecap="round" stroke-linejoin="round" d="M3 16.5v2.25A2.25 2.25 0 0 0 5.25 21h13.5A2.25 2.25 0 0 0 21 18.75V16.5m-13.5-9L12 3m0 0 4.5 4.5M12 3v13.5" />
                                        </svg>
                                        <span class="text-sm text-[#64748B]">Tap to select a selfie</span>
                                        <span class="text-xs text-[#64748B] mt-1">JPEG or PNG, max 10MB</span>
                                        <input type="file" x-ref="fileInputSelfie" accept="image/jpeg,image/png" capture="user" class="hidden" @change="handleFileUpload('selfie', $event)">
                                    </label>
                                </div>

                                <div class="mt-3 text-center">
                                    <button type="button" @click="switchSelfieMethod()" class="text-xs text-[#64748B] hover:text-[#2AA7A1] underline transition-colors">
                                        <span x-text="selfieCaptureMethod === 'camera' ? 'Upload a photo instead' : 'Use camera instead'"></span>
                                    </button>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="bg-white rounded-xl border border-[#E2E8F0] p-5">
                                ...
                                <div x-show="faceCheckDone && !faceDetected" class="mt-3 max-w-sm mx-auto">
                                    <div class="flex items-start gap-2.5 p-3 rounded-xl bg-amber-50">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-xs text-[#64748B] mt-1">Face the camera directly with good lighting. You can retake or continue — our team will check.</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div x-show="faceCheckDone && faceDetected" class="mt-3 max-w-sm mx-auto">
                                    <div class="flex items-center gap-2 px-3 py-2.5 rounded-xl bg-green-50">
                                        ...
                                        <span class="text-sm text-[#1F2937]" x-text="livenessPassed ? 'Liveness verified!' : 'Looking good!'"></span>
                                    </div>
                                </div>
                    ...
                    <div x-show="step === 4" x-transition:enter.duration.200ms>
                        ...
                        <div class="mt-6">
                            <button type="button" @click="nextStep()" :disabled="!businessName || !contactNumber || !businessAddress"
                                class="w-full py-3 rounded-xl text-sm font-semibold text-white transition-all duration-150 disabled:opacity-40 disabled:cursor-not-allowed"
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="bg-white rounded-xl border border-[#E2E8F0] p-5">
                                ...
                                <div x-show="ocrResult" class="space-y-2">
                                    <div class="flex items-center gap-2 px-3 py-2.5 rounded-xl"
                                        ...
                                        <span class="text-xs text-[#1F2937]" x-text="ocrResult?.status === 'pass' ? 'Name found on ID' : (ocrResult?.status === 'partial' ? 'Partial name match — team will verify' : 'Name not verified — team will check')"></span>
                                    </div>
                                    <div class="flex items-center gap-2 px-3 py-2.5 rounded-xl"
                                        ...
                                        <svg class="w-4 h-4 shrink-0" :class="ocrResult?.type_match === 'match' ? 'text-[#22C55E]' : 'text-[#FBBF24]'" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                                            <path x-show="ocrResult?.type_match === 'match'" stroke-linecap="round" stroke-linejoin="round" d="M9 12.75 11.25 15 15 9.75M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" />
                                            <path x-show="ocrResult?.type_match !== 'match'" stroke-linecap="round" stroke-linejoin="round" d="M12 9v3.75m-9.303 3.376c-.866 1.5.217 3.374 1.948 3.374h14.71c1.73 0 2.814-1.874 1.948-3.374L13.949 3.378c-.866-1.5-3.032-1.5-3.898 0L2.697 16.126ZM12 15.75h.007v.008H12v-.008Z" />
                                        </svg>
                                        <span class="text-xs text-[#1F2937]" x-text="ocrResult?.type_match === 'match' ? 'Looks like a ' + idType : 'Document type not confirmed — team will check'"></span>
                                    </div>
                                    <div x-show="ocrResult?.id_number" class="flex items-center gap-2 px-3 py-2.5 rounded-xl bg-[#EEF8F8]">
                                    ...
                                    <div x-show="faceCheckDone" class="flex items-center gap-2 px-3 py-2.5 rounded-xl"
                                        ...
                                        <svg class="w-4 h-4 shrink-0" :class="faceDetected ? 'text-[#22C55E]' : 'text-[#FBBF24]'" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                                            <path x-show="faceDetected" stroke-linecap="round" stroke-linejoin="round" d="M9 12.75 11.25 15 15 9.75M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" />
                                            <path x-show="!faceDetected" stroke-linecap="round" stroke-linejoin="round" d="M12 9v3.75m-9.303 3.376c-.866 1.5.217 3.374 1.948 3.374h14.71c1.73 0 2.814-1.874 1.948-3.374L13.949 3.378c-.866-1.5-3.032-1.5-3.898 0L2.697 16.126ZM12 15.75h.007v.008H12v-.008Z" />
                                        </svg>
                                        <span class="text-xs text-[#1F2937]" x-text="faceDetected ? 'Selfie looks good' : 'Face not clearly visible — team will check'"></span>
                                    </div>
                                </div>
                            ...
                            <div class="bg-white rounded-xl border border-[#E2E8F0] p-5">
                                ...
                                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4" :class="needsBack ? 'lg:grid-cols-3' : ''">
                                    <div>
                                        <p class="text-xs text-[#64748B] mb-1.5" x-text="needsBack ? 'ID Front' : 'Government ID'"></p>
                                        <div class="rounded-xl overflow-hidden border border-[#E2E8F0] cursor-pointer" @click="openPreview(idImageBase64)">
                                    ...
                                    <div x-show="needsBack && idBackBase64">
                                        ...
                                        <div class="rounded-xl overflow-hidden border border-[#E2E8F0] cursor-pointer" @click="openPreview(idBackBase64)">
                                            <img :src="idBackBase64" alt="Back of ID" class="w-full">
                                        </div>
                                    </div>
                                    <div>
                                        <p class="text-xs text-[#64748B] mb-1.5">Selfie</p>
                                        <div class="rounded-xl overflow-hidden border border-[#E2E8F0] cursor-pointer" @click="openPreview(selfieBase64)">
