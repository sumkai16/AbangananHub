        ...
        <div class="max-w-2xl mx-auto"
            ...
            <form method="POST"
                ...
                <div x-show="step === 2" x-transition:enter.duration.200ms>
                    <div class="bg-white rounded-lg border border-[#E2E8F0] p-6">
                        ...
                        <p class="text-sm text-[#64748B] mb-4">
                            <template x-if="needsBack"><span>Take photos of both the front and back of your ID.</span></template>
                            <template x-if="!needsBack"><span>Take a photo of the data page of your Passport.</span></template>
                        </p>
                        ...
                        {{-- Thumbnail row — shows captured photos as compact previews --}}
                        <div x-show="idImageBase64 && idCapturePhase !== 'capture-front'" class="mb-4">
                            <div class="grid gap-4" :class="needsBack ? 'grid-cols-2' : 'grid-cols-1 max-w-xs'">
                                {{-- Front thumbnail --}}
                                <div class="relative">
                                    <div class="rounded-lg overflow-hidden border-2 border-[#22C55E] cursor-pointer" @click="openPreview(idImageBase64)">
                                        <img :src="idImageBase64" alt="Front" class="w-full aspect-[4/3] object-cover">
                                    </div>
                                    <div class="absolute -top-1.5 -right-1.5 w-5 h-5 rounded-full bg-[#22C55E] flex items-center justify-center">
                                    ...
                                    <div class="flex items-center justify-between mt-1.5">
                                        <span class="text-xs text-[#64748B]" x-text="needsBack ? 'Front' : 'ID Photo'"></span>
                                        <button type="button" @click="retakePhoto('id')" class="text-xs text-[#2AA7A1] hover:underline">Retake</button>
                                    </div>
                                </div>
                                ...
                                <div x-show="needsBack" class="relative">
                                    <template x-if="idBackBase64">
                                        <div>
                                            <div class="rounded-lg overflow-hidden border-2 border-[#22C55E] cursor-pointer" @click="openPreview(idBackBase64)">
                                                <img :src="idBackBase64" alt="Back" class="w-full aspect-[4/3] object-cover">
                                            </div>
                                            <div class="absolute -top-1.5 -right-1.5 w-5 h-5 rounded-full bg-[#22C55E] flex items-center justify-center">
                                                <svg class="w-3 h-3 text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="3" stroke="currentColor">
                                                    <path stroke-linecap="round" stroke-linejoin="round" d="m4.5 12.75 6 6 9-13.5" />
                                            ...
                                            <div class="flex items-center justify-between mt-1.5">
                                                ...
                                                <button type="button" @click="retakePhoto('idBack')" class="text-xs text-[#2AA7A1] hover:underline">Retake</button>
                                            </div>
                                        </div>
                                    </template>
                                    <template x-if="!idBackBase64">
                                        <div class="rounded-lg border-2 border-dashed border-[#E2E8F0] aspect-[4/3] flex items-center justify-center">
                                            <span class="text-xs text-[#64748B]">Back</span>
                                        </div>
                                    </template>
                                </div>
                        ...
                        <div x-show="duplicateSideWarning" class="mt-4">
                            <div class="flex items-start gap-2.5 p-3 rounded-lg bg-amber-50">
                                <svg class="w-4 h-4 text-[#FBBF24] mt-0.5 shrink-0" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M12 9v3.75m-9.303 3.376c-.866 1.5.217 3.374 1.948 3.374h14.71c1.73 0 2.814-1.874 1.948-3.374L13.949 3.378c-.866-1.5-3.032-1.5-3.898 0L2.697 16.126ZM12 15.75h.007v.008H12v-.008Z" /></svg>
                                <div>
                                    <p class="text-sm font-semibold text-[#1F2937]">These photos look the same</p>
                                    <p class="text-xs text-[#64748B] mt-1">It looks like you may have captured the same side twice. Please flip your ID over and retake the back photo.</p>
                                </div>
                            </div>
                        </div>

                        {{-- OCR warnings — shown after all captures complete --}}
                        <div x-show="idCapturePhase === 'done' && (ocrLoading || ocrResult || ocrError)" class="mt-4">
                            <div x-show="ocrLoading" class="flex items-center gap-2 py-4 justify-center">
                                <svg class="animate-spin h-4 w-4 text-[#2AA7A1]" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                                    ...
                                    <div class="space-y-2">
                                        ...
                                        <div class="flex items-start gap-2.5 p-3 rounded-lg"
                                            ...
                                            <template x-if="ocrResult?.status === 'pass'">
                                                <svg class="w-4 h-4 text-[#22C55E] mt-0.5 shrink-0" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M9 12.75 11.25 15 15 9.75M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" /></svg>
                                            </template>
                                            <template x-if="ocrResult?.status !== 'pass'">
                                                <svg class="w-4 h-4 mt-0.5 shrink-0" :class="ocrResult?.status === 'partial' ? 'text-[#FBBF24]' : 'text-[#EF4444]'" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M12 9v3.75m-9.303 3.376c-.866 1.5.217 3.374 1.948 3.374h14.71c1.73 0 2.814-1.874 1.948-3.374L13.949 3.378c-.866-1.5-3.032-1.5-3.898 0L2.697 16.126ZM12 15.75h.007v.008H12v-.008Z" /></svg>
                                            </template>
                                            <div>
                                                <p class="text-sm font-semibold text-[#1F2937]"
                                                   x-text="ocrResult?.status === 'pass' ? 'We found your name on this ID' : (ocrResult?.status === 'partial' ? 'We found a partial match for your name' : 'We couldn\'t find your name on this ID')"></p>
                                                <p class="text-xs text-[#64748B] mt-1" x-show="ocrResult?.status === 'partial'">The name on the ID is close but doesn't exactly match your account name. Try retaking with better lighting, or continue — our team will verify it.</p>
                                                <p class="text-xs text-[#64748B] mt-1" x-show="ocrResult?.status === 'fail'">Make sure the text is clear and well-lit. You can retake the photo above, or continue anyway — our team will check it manually.</p>
                                            </div>
                                        </div>

                                        {{-- Type match --}}
                                        <div x-show="ocrResult?.type_match === 'mismatch'" class="flex items-start gap-2.5 p-3 rounded-lg bg-amber-50">
                                            <svg class="w-4 h-4 text-[#FBBF24] mt-0.5 shrink-0" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M12 9v3.75m-9.303 3.376c-.866 1.5.217 3.374 1.948 3.374h14.71c1.73 0 2.814-1.874 1.948-3.374L13.949 3.378c-.866-1.5-3.032-1.5-3.898 0L2.697 16.126ZM12 15.75h.007v.008H12v-.008Z" /></svg>
                                            <div>
                                                <p class="text-sm font-semibold text-[#1F2937]">This doesn't look like a <span x-text="idType"></span></p>
                                                <p class="text-xs text-[#64748B] mt-1">Make sure you photographed the same type of ID you selected in Step 1. You can retake above if needed.</p>
                                            </div>
                                        </div>
                                        <div x-show="ocrResult?.type_match === 'match'" class="flex items-center gap-2 p-3 rounded-lg bg-green-50">
                                            ...
                                            <span class="text-sm text-[#1F2937]">This looks like a <span class="font-medium" x-text="idType"></span></span>
                                        </div>
                                    </div>
                                </div>
                            </template>
                        ...
                        <div x-show="idCapturePhase === 'capture-front'" class="relative">
                            <p class="text-xs font-semibold text-[#1F2937] mb-2" x-text="needsBack ? 'Front of ID' : 'ID Data Page'"></p>
                            ...
                            <div x-show="faceCheckDone && !faceDetected" class="mt-3 max-w-sm mx-auto">
                                <div class="flex items-start gap-2.5 p-3 rounded-lg bg-amber-50">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-xs text-[#64748B] mt-1">Face the camera directly, remove any sunglasses or hats, and use good lighting. You can retake or continue — our team will check it.</p>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="bg-white rounded-lg border border-[#E2E8F0] p-6">
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                ...
                                <textarea id="description" name="description" rows="3" x-model="description" maxlength="1000"
                        ...
                        <div class="bg-white rounded-lg border border-[#E2E8F0] p-6">
                            ...
                            <div x-show="ocrResult" class="space-y-2 mb-4">
                                ...
                                <div class="flex items-center gap-2 px-3 py-2 rounded-lg"
                                    ...
                                    <template x-if="ocrResult?.status !== 'pass'">
                                        <svg class="w-4 h-4 shrink-0" :class="ocrResult?.status === 'partial' ? 'text-[#FBBF24]' : 'text-[#EF4444]'" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M12 9v3.75m-9.303 3.376c-.866 1.5.217 3.374 1.948 3.374h14.71c1.73 0 2.814-1.874 1.948-3.374L13.949 3.378c-.866-1.5-3.032-1.5-3.898 0L2.697 16.126ZM12 15.75h.007v.008H12v-.008Z" /></svg>
                                    </template>
                                    <span class="text-xs text-[#1F2937]" x-text="ocrResult?.status === 'pass' ? 'We found your name on this ID' : (ocrResult?.status === 'partial' ? 'Partial name match — our team will verify' : 'Name not verified — our team will check')"></span>
                                </div>
                                {{-- Type --}}
                                <div class="flex items-center gap-2 px-3 py-2 rounded-lg"
                                     :class="ocrResult?.type_match === 'match' ? 'bg-green-50' : 'bg-amber-50'">
                                    <svg class="w-4 h-4 shrink-0" :class="ocrResult?.type_match === 'match' ? 'text-[#22C55E]' : 'text-[#FBBF24]'" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                                        <template x-if="ocrResult?.type_match === 'match'"><path stroke-linecap="round" stroke-linejoin="round" d="M9 12.75 11.25 15 15 9.75M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" /></template>
                                        <template x-if="ocrResult?.type_match !== 'match'"><path stroke-linecap="round" stroke-linejoin="round" d="M12 9v3.75m-9.303 3.376c-.866 1.5.217 3.374 1.948 3.374h14.71c1.73 0 2.814-1.874 1.948-3.374L13.949 3.378c-.866-1.5-3.032-1.5-3.898 0L2.697 16.126ZM12 15.75h.007v.008H12v-.008Z" /></template>
                                    </svg>
                                    <span class="text-xs text-[#1F2937]" x-text="ocrResult?.type_match === 'match' ? 'This looks like a ' + idType : 'Document type not confirmed — our team will check'"></span>
                                </div>
                                {{-- ID Number --}}
                                ...
                                <div x-show="faceCheckDone" class="flex items-center gap-2 px-3 py-2 rounded-lg"
                                    ...
                                    <svg class="w-4 h-4 shrink-0" :class="faceDetected ? 'text-[#22C55E]' : 'text-[#FBBF24]'" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                                        <template x-if="faceDetected"><path stroke-linecap="round" stroke-linejoin="round" d="M9 12.75 11.25 15 15 9.75M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" /></template>
                                        <template x-if="!faceDetected"><path stroke-linecap="round" stroke-linejoin="round" d="M12 9v3.75m-9.303 3.376c-.866 1.5.217 3.374 1.948 3.374h14.71c1.73 0 2.814-1.874 1.948-3.374L13.949 3.378c-.866-1.5-3.032-1.5-3.898 0L2.697 16.126ZM12 15.75h.007v.008H12v-.008Z" /></template>
                                    </svg>
                                    <span class="text-xs text-[#1F2937]" x-text="faceDetected ? 'Selfie looks good' : 'Face not clearly visible — our team will check'"></span>
                                </div>
                            </div>
                        ...
                        <div class="bg-white rounded-lg border border-[#E2E8F0] p-6">
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4" :class="needsBack ? 'lg:grid-cols-3' : ''">
                                <div>
                                    ...
                                    <div class="rounded-lg overflow-hidden border border-[#E2E8F0] cursor-pointer" @click="openPreview(idImageBase64)">
                                ...
                                <div x-show="needsBack && idBackBase64">
                                    ...
                                    <div class="rounded-lg overflow-hidden border border-[#E2E8F0] cursor-pointer" @click="openPreview(idBackBase64)">
                                        <img :src="idBackBase64" alt="Back of ID" class="w-full">
                                    </div>
                                </div>
                                <div>
                                    <p class="text-xs font-medium text-[#64748B] mb-2">Selfie</p>
                                    <div class="rounded-lg overflow-hidden border border-[#E2E8F0] cursor-pointer" @click="openPreview(selfieBase64)">
                ...
                <div x-show="previewImage"
                    ...
                    <img :src="previewImage" alt="ID Preview" @click.stop class="max-w-full max-h-[85vh] rounded-lg cursor-default">
                </div>
            </form>
        </div>
    </div>
