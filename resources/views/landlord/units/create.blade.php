...
@section('content')
    <div class="max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8 py-8 pb-16">
        ...
        <div class="flex flex-wrap items-center gap-1.5 text-sm text-[#5B6A8E] mb-2">
            ...
            <span class="text-[#060D26] font-medium">Add New Unit</span>
        </div>
                ...
                <div class="lg:col-span-7 space-y-6">
                    ...
                    <x-card flush class="p-6">
                        ...
                        <div class="mb-5">
                            ...
                            @php
                                $statusOptions = [
                                    ...
                                    'Maintenance' => ['desc' => 'Temporarily unavailable', 'dot' => 'bg-[#5B6A8E]', 'active' => 'border-[#E2E4EC] bg-[#F7F8FC]'],
                                ];
                                ...
                                @foreach($statusOptions as $value => $opt)
                                    <label class="relative cursor-pointer rounded-xl border px-3 py-3 transition-colors duration-150"
                                        ...
                                        <div class="flex items-center gap-1.5 mb-0.5">
                                            ...
                                            <p class="text-[13px] font-semibold text-[#060D26]">{{ $value }}</p>
                                        </div>
                        ...
                        <div>
                            <div class="flex items-center justify-between mb-1.5">
                                <label class="block text-[12px] font-semibold text-[#060D26]">Description</label>
                                <span class="text-[11px] text-[#5B6A8E]" x-text="description.length + ' / 300'"></span>
                            </div>
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <button type="submit" :disabled="submitting"
                            class="h-11 px-6 inline-flex items-center justify-center gap-2 rounded-full bg-[#DA8E77] text-[#060D26] text-sm font-semibold hover:bg-[#C97A61] transition-all duration-200 disabled:opacity-70 disabled:cursor-wait">
                    ...
                    <div class="space-y-6">
                        <x-card flush>
                            ...
                            <div class="p-5 space-y-3">
                                ...
                                {{-- Description --}}
                                <p class="text-[12px] text-[#5B6A8E] leading-relaxed line-clamp-3 pt-1"
