                    ...
                    <x-card flush class="p-6">
                        ...
                        <div>
                            ...
                            <textarea name="description" rows="3" maxlength="300" x-model="description"
                                ...
                                class="w-full rounded-xl border border-[#5B6A8E]/30 px-3.5 py-2.5 text-[13.5px] text-[#060D26] placeholder-[#5B6A8E] focus:outline-none focus:ring-2 focus:ring-[#C9A84C]/30 transition resize-none"></textarea>
                            @error('description')
                                <p class="text-[11.5px] text-[#EF4444] mt-1">{{ $message }}</p>
                            @enderror
                        </div>
