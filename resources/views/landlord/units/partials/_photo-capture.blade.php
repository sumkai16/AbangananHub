...
<x-card flush class="p-5 sm:p-6" x-data="{ tab: 'live' }">
    <div class="flex items-start gap-3 mb-5">
        ...
        <div>
            <h2 class="text-[15px] font-semibold text-[#060D26] leading-tight">
                {{ $existingLiveCount > 0 ? 'Add more photos' : 'Unit Photos' }}
                @if($existingLiveCount === 0)<span class="text-[#EF4444]">*</span>@endif
            </h2>
            <p class="text-[12.5px] text-[#5B6A8E] mt-1 leading-snug">
