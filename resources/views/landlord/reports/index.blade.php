...
@section('content')
    <div class="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-[50px] py-8">
        ...
        {{-- Header --}}
        <div class="mb-6">
            <h1 class="text-[20px] font-bold text-[#156F8C]">My Reports</h1>
                    ...
                    <table class="w-full text-left">
                        <thead>
                            <tr class="bg-[#EEF8F8]">
                                ...
                                <th class="px-5 py-3 text-[12px] font-semibold text-[#156F8C]">Against</th>
                                <th class="px-5 py-3 text-[12px] font-semibold text-[#156F8C]">Property</th>
                                <th class="px-5 py-3 text-[12px] font-semibold text-[#156F8C]">Date</th>
