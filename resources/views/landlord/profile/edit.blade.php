...
@section('content')
    <div class="max-w-[900px] mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <a href="{{ route('landlord.profile.me') }}"
            class="inline-flex items-center gap-1.5 text-[13px] font-medium text-[#5B6A8E] hover:text-[#060D26] transition-colors mb-6">
        ...
        <h1 class="text-[22px] font-normal text-[#060D26] mb-6">Edit profile</h1>
        ...
        <form action="{{ route('landlord.profile.update') }}" method="POST" enctype="multipart/form-data">
            ...
            {{-- Profile picture --}}
            <div class="bg-white border border-[#E2E4EC] rounded-2xl shadow-[0_1px_3px_rgba(6,13,38,0.06)] p-5 mb-5">
                ...
                <div class="flex items-center gap-5">
                    ...
                    @else
                        <div
                            class="w-20 h-20 rounded-full bg-[#060D26] flex items-center justify-center text-white text-[28px] font-bold">
                            {{ strtoupper(substr($user->first_name, 0, 1)) }}{{ strtoupper(substr($user->last_name, 0, 1)) }}
                        </div>
                    @endif
                    <div>
                        <label
                            class="inline-flex items-center gap-2 px-4 py-2 border border-[#E2E4EC] rounded-lg text-[13px] font-semibold text-[#060D26] bg-white hover:brightness-95 transition-all cursor-pointer">
                        ...
                        <p class="text-[11px] text-[#5B6A8E] mt-2">JPG, PNG. Max 2MB. Will be cropped to square.</p>
            ...
            {{-- Personal info --}}
            <div class="bg-white border border-[#E2E4EC] rounded-2xl shadow-[0_1px_3px_rgba(6,13,38,0.06)] p-5 mb-5">
                <h2 class="text-[15px] font-normal text-[#060D26] mb-4">Personal information</h2>
...
=======
                            class="w-full px-3.5 py-2.5 bg-white border border-[#E2E4EC] rounded-lg text-[14px] text-[#060D26] placeholder-[#5B6A8E]/50 focus:border-[#FF8A66] focus:ring-2 focus:ring-[#FF8A66]/20 focus:outline-none transition-all">
...
>>>>>>> 092fb1454a20ae889717d4d8b1bee67f9c0c8eaa
                ...
                <div class="mb-4">
                    <label for="email" class="block text-[13px] font-semibold text-[#5B6A8E] mb-1.5">Email address</label>
                    <input type="email" id="email" value="{{ $user->email }}" disabled
                        class="w-full px-3.5 py-2.5 bg-[#F7F8FC] border border-[#E2E4EC] rounded-lg text-[14px] text-[#5B6A8E] cursor-not-allowed">
                    <p class="text-[11px] text-[#5B6A8E] mt-1.5">Email can be changed in <a
                            href="{{ route('profile.edit') }}" class="text-[#060D26] hover:underline">Settings</a>.</p>
                </div>
...
=======
                            class="w-full px-3.5 py-2.5 bg-white border border-[#E2E4EC] rounded-lg text-[14px] text-[#060D26] placeholder-[#5B6A8E]/50 focus:border-[#FF8A66] focus:ring-2 focus:ring-[#FF8A66]/20 focus:outline-none transition-all resize-none"
>>>>>>> 092fb1454a20ae889717d4d8b1bee67f9c0c8eaa
            ...
            {{-- Payout details --}}
            <div class="bg-white border border-[#E2E4EC] rounded-2xl shadow-[0_1px_3px_rgba(6,13,38,0.06)] p-5 mb-5">
                <h2 class="text-[15px] font-normal text-[#060D26] mb-1">Payout details</h2>
                <p class="text-[12px] text-[#5B6A8E] mb-4">Where AbangananHub sends the rent and deposits it collects on your behalf. Both fields are required before you can be paid out.</p>
...
>>>>>>> 092fb1454a20ae889717d4d8b1bee67f9c0c8eaa
            ...
            {{-- Business info --}}
            <div class="bg-white border border-[#E2E4EC] rounded-2xl shadow-[0_1px_3px_rgba(6,13,38,0.06)] p-5 mb-5">
                <h2 class="text-[15px] font-normal text-[#060D26] mb-1">Business information</h2>
                <p class="text-[12px] text-[#5B6A8E] mb-4">Shown on your public landlord profile.</p>

                {{-- Logo --}}
                <div x-data="{ preview: null }" class="flex items-center gap-5 mb-5 pb-5 border-b border-[#E2E4EC]">
                    ...
                    <template x-if="!preview">
                        ...
                        @else
                            <div
                                class="w-16 h-16 rounded-xl bg-[#ECEEF6] border border-[#E2E4EC] flex items-center justify-center">
                                <svg width="24" height="24" fill="none" viewBox="0 0 24 24" stroke="#5B6A8E" stroke-width="1.5">
                                    <path stroke-linecap="round" stroke-linejoin="round"
                    ...
                    <div>
                        <label
                            class="inline-flex items-center gap-2 px-3 py-1.5 border border-[#E2E4EC] rounded-lg text-[12px] font-semibold text-[#060D26] bg-white hover:brightness-95 transition-all cursor-pointer">
                        ...
                        <p class="text-[11px] text-[#5B6A8E] mt-1.5">JPG, PNG, or WebP. Max 2MB.</p>
                        @error('logo')
                            <p class="text-[11px] text-[#EF4444] mt-1.5 font-semibold">{{ $message }}</p>
                        @enderror
                    </div>
...
>>>>>>> 092fb1454a20ae889717d4d8b1bee67f9c0c8eaa
            ...
            <div class="flex items-center justify-end gap-3">
                <a href="{{ route('landlord.profile.me') }}"
                    class="px-5 py-2.5 border border-[#E2E4EC] rounded-lg text-[13px] font-semibold text-[#060D26] bg-white hover:brightness-95 transition-all">
                    Cancel
                </a>
                <button type="submit"
                    class="px-5 py-2.5 bg-[#FF8A66] text-[#060D26] rounded-lg text-[13px] font-semibold hover:bg-[#E96F4F] transition-all shadow-sm">
                    Save changes
                </button>
            </div>
        </form>
