        ...
        <div class="max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div
                ...
                <div class="flex flex-wrap items-center gap-2">
                    ...
                    <span
                        class="inline-flex items-center gap-1.5 px-3.5 py-1.5 rounded-full text-[11px] font-bold uppercase bg-[#ECEEF6] text-[#060D26] border border-[#FF8A66]/20">
                    ...
                    <x-card flush class="lg:col-span-7 p-5 sm:p-8 space-y-6">
                        ...
                        <div>
                            ...
                            <input type="text" id="title" name="title" value="{{ old('title', $property->title) }}" minlength="10"
                                maxlength="150"
                                class="w-full h-12 px-4 rounded-2xl border border-[#E2E4EC] text-[14px] font-medium text-[#060D26] focus:outline-none focus:ring-2 focus:ring-[#FF8A66]/20 focus:border-[#FF8A66] transition-all"
                                required>
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input type="number" step="0.01" min="500" max="999999" name="rental_fee" id="rental_fee"
                                        ...
                                        class="w-full h-12 pl-8 pr-4 rounded-2xl border border-[#E2E4EC] text-[14px] font-bold text-[#060D26] focus:outline-none focus:ring-2 focus:ring-[#FF8A66]/20 focus:border-[#FF8A66] transition-all"
                                        required>
                                </div>
                        ...
                        <div>
                            ...
                            <textarea name="description" rows="6" minlength="20" maxlength="3000"
                                class="w-full p-4 rounded-2xl border border-[#E2E4EC] text-[14px] text-[#060D26] leading-relaxed focus:outline-none focus:ring-2 focus:ring-[#FF8A66]/20 focus:border-[#FF8A66] transition-all"
                        ...
                        <div class="sticky top-8 space-y-6">
                            ...
                            <x-card flush class="p-6">
                                <div class="flex items-center justify-between border-b border-[#E2E4EC] pb-3 mb-4">
                                    ...
                                    <span
                                        class="text-[10px] font-bold uppercase text-[#060D26] bg-[#ECEEF6] px-2.5 py-0.5 rounded-full border border-[#FF8A66]/20">
                            ...
                            <x-card flush class="p-6 space-y-4">
                                ...
                                <div
                                    class="border-2 border-dashed border-[#E2E4EC] hover:border-[#FF8A66] rounded-3xl p-6 bg-[#F7F8FC] text-center transition-colors group">
                            ...
                            <div class="rounded-3xl bg-[#ECEEF6]/50 border border-[#FF8A66]/20 p-5">
                            ...
                            <div class="flex items-center gap-3">
                                ...
                                <button type="submit"
                                    class="w-2/3 h-12 rounded-full bg-[#FF8A66] text-[#060D26] font-bold text-[13.5px] shadow-sm hover:bg-[#E96F4F] transition-all duration-300">
                                    Save Changes
                                </button>
                            </div>
                        </div>
