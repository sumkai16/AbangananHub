...
=======
                    <div class="mt-5 max-w-2xl rounded-xl bg-[#ECEEF6]/70 border border-[#FF8A66]/20 p-4 flex gap-3">
                        <svg class="w-5 h-5 text-[#B35A3D] shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
