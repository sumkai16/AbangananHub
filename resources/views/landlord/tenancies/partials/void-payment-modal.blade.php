        ...
        <div x-show="show" x-cloak class="fixed inset-0 z-50 flex items-center justify-center p-4" role="dialog"
            ...
            <div x-show="show"
                ...
                <div class="flex items-start justify-between gap-4 px-6 pt-6 pb-4">
                    <div>
                        <h2 id="void-payment-title" class="text-[17px] font-normal text-[#060D26]">Void this payment</h2>
                ...
                <form method="POST" :action="payment.action" class="px-6 pb-6">
                    ...
                    <div class="mb-4">
                        <label for="void_reason" class="block text-[12px] font-semibold text-[#060D26] mb-1.5">
...
>>>>>>> 092fb1454a20ae889717d4d8b1bee67f9c0c8eaa
                    ...
                    <div x-show="reason === 'other'" x-cloak class="mb-4">
                        <label for="void_note" class="block text-[12px] font-semibold text-[#060D26] mb-1.5">
...
=======
                            class="mt-0.5 w-4 h-4 rounded border-[#5B6A8E]/40 text-[#B35A3D] focus:ring-[#FF8A66]/30 cursor-pointer">
>>>>>>> 092fb1454a20ae889717d4d8b1bee67f9c0c8eaa
