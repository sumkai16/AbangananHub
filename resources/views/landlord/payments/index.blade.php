    ...
    <div class="max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8 py-6 pb-10">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 mb-4">
            <x-stat-card label="Due This Month" :value="'₱' . number_format($totals['dueThisMonth'], 2)"
                value-color="#060D26" icon-bg="#ECEEF6"
            ...
            <x-stat-card label="Total Unpaid" :value="'₱' . number_format($totals['outstanding'], 2)"
                :value-color="$totals['outstanding'] > 0 ? '#060D26' : '#060D26'" icon-bg="#ECEEF6"
            ...
            <x-stat-card label="Overdue" :value="'₱' . number_format($totals['overdue'], 2)"
                :value-color="$totals['overdue'] > 0 ? '#DC2626' : '#060D26'"
                :icon-bg="$totals['overdue'] > 0 ? 'rgba(239,68,68,0.07)' : '#ECEEF6'"
                        ...
                        <tbody class="divide-y divide-[#E2E4EC]">
                            @foreach($displayRows as $item)
                                ...
                                <tr class="hover:bg-[#F7F8FC] transition-colors duration-150">
                                    ...
                                    <td class="px-4 py-4 text-[13px] text-[#5B6A8E] text-right whitespace-nowrap">
                                    ...
                                    <td
                                        class="px-4 py-4 text-[13px] text-right whitespace-nowrap {{ $summary['outstanding'] > 0 ? 'font-semibold text-[#DC2626]' : 'text-[#5B6A8E]' }}">
                                        ₱{{ number_format($summary['outstanding'], 2) }}
                                        @if($item['monthsLabel'])
