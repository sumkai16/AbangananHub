                    ...
                    <div class="lg:col-span-2 space-y-5">
                        ...
                        <x-card>
                            ...
                            <div x-show="mode === 'new'" x-cloak>
                                ...
                                <div class="mt-4 flex items-start gap-2.5 rounded-xl bg-[#ECEEF6]/60 border border-[#C9A84C]/20 px-3.5 py-3">
                        ...
                        <x-card>
                            ...
                            <div class="mb-5">
                                ...
                                <button type="button" x-show="!unit" @click="openPicker()"
                                    class="w-full flex items-center gap-3 rounded-xl border border-dashed border-[#5B6A8E]/40 bg-[#F7F8FC] px-4 py-3.5 text-left hover:border-[#C9A84C]/60 hover:bg-[#ECEEF6]/40 transition-all duration-200 cursor-pointer">
                                ...
                                <div x-show="unit" x-cloak
                                    class="flex items-center gap-3 rounded-xl border border-[#C9A84C]/30 bg-[#ECEEF6]/40 p-2.5">
                                    ...
                                    <div class="min-w-0 flex-1">
                                        ...
                                        <div class="flex items-center gap-2.5 mt-0.5">
                                            <span class="text-[12.5px] font-bold text-[#8a6e1e]" x-text="unit ? '₱' + unit.rent.toLocaleString('en-PH') : ''"></span>
                                            <span class="text-[11px] text-[#5B6A8E]" x-show="unit && unit.cap" x-text="unit ? unit.cap + ' pax' : ''"></span>
                                        </div>
                                    </div>
                                    <button type="button" @click="openPicker()"
                                        class="h-9 px-4 shrink-0 rounded-full border border-[#C9A84C] text-[#8a6e1e] text-[12px] font-semibold hover:bg-white transition-colors duration-200 cursor-pointer">
                                        Change
                                    </button>
                                </div>
                            ...
                            <div class="mt-4">
                                ...
                                <textarea id="notes" name="notes" rows="2" maxlength="1000"
                                    ...
                                    class="w-full rounded-xl border border-[#5B6A8E]/30 px-3.5 py-2.5 text-[13.5px] text-[#060D26] placeholder-[#5B6A8E] focus:outline-none focus:ring-2 focus:ring-[#C9A84C]/30 transition resize-y">{{ old('notes') }}</textarea>
                                @error('notes')
                                    <p class="{{ $errorClass }}">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div class="flex items-start justify-between gap-4 mb-1">
                                ...
                                <label for="has_payment" class="flex items-center gap-2 cursor-pointer shrink-0 pt-1"
                                    ...
                                    <input type="checkbox" id="has_payment" x-model="hasPayment"
                                        class="w-4 h-4 rounded border-[#5B6A8E]/40 text-[#8a6e1e] focus:ring-[#C9A84C]/30 cursor-pointer">
                            ...
                            <div x-show="hasPayment || paymentRequired" x-cloak class="mt-5">
                                ...
                                <div class="grid sm:grid-cols-2 gap-4 mb-4">
                                    ...
                                    <div x-show="received > 0" x-cloak
                                        class="rounded-xl border border-[#C9A84C]/25 bg-[#ECEEF6]/50 px-4 py-3.5">
                                        ...
                                        <div class="space-y-1.5 text-[13px]">
                                            ...
                                            <div class="h-px bg-[#C9A84C]/20 my-2"></div>
                                            <div class="flex items-center justify-between gap-3">
                    ...
                    <div class="lg:sticky lg:top-6">
                        <x-card>
                            ...
                            <div class="space-y-3.5 text-[13px]">
                                ...
                                <div class="flex items-start justify-between gap-3">
                                    <span class="text-[#5B6A8E]">Monthly rent</span>
                                    <span class="font-bold text-[#8a6e1e] text-right" x-text="peso(effectiveRent)"></span>
                                </div>
                                <div class="flex items-start justify-between gap-3">
                            ...
                            <div class="px-6 pt-6 pb-4 border-b border-[#E2E4EC]">
                                ...
                                <div class="relative">
                                    ...
                                    <input type="text" id="unit-search" x-model="unitSearch"
                                        ...
                                        class="w-full h-11 pl-10 pr-4 text-[13.5px] rounded-xl border border-[#E2E4EC] bg-[#F7F8FC] text-[#060D26] placeholder-[#94A3B8] focus:outline-none focus:ring-2 focus:ring-[#C9A84C]/20 focus:border-[#C9A84C] focus:bg-white transition-all duration-200">
                                </div>
                            </div>
                                            ...
                                            <template x-for="u in property.units" :key="u.id">
                                                <button type="button" @click="pick(u.id)"
                                                    :class="String(unitId) === String(u.id)
                                                        ...
                                                        : 'border-[#E2E4EC] hover:border-[#C9A84C]/50 hover:shadow-[0_4px_16px_rgba(6,13,38,0.08)]'"
                                                    class="group relative text-left rounded-xl border overflow-hidden transition-all duration-200 cursor-pointer focus:outline-none focus:ring-2 focus:ring-[#C9A84C]/40">
                                                    ...
                                                    <div class="p-2.5">
                                                        ...
                                                        <div class="flex items-center justify-between gap-2 mt-1">
                                                            <span class="text-[12.5px] font-bold text-[#8a6e1e]"
