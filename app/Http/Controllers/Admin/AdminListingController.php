...
class ListingController extends Controller
{
    ...
    public function approval()
    {
        ...
        $pendingListings = Property::with('landlord') // Uses your 'landlord' relationship
    ...
    {
        // Finds the property using your custom primary key 'property_id'
        $property = Property::where('property_id', $property_id)->firstOrFail();
        
        // Update the enum status to Approved
    ...
    public function reject($property_id)
    {
        ...
        // Update the enum status to Rejected
